...
from agentwolf.models.model_configs import AnyModelConfig
from agentwolf_config.converters import ConversionConfig
from agentwolf_config.tools import ImportToolConfig
from agentwolf_config.workers import AgentWorkerConfig, WorkerConfig
...
class EntryPointToolsetConfig(BaseToolsetConfig):
    ...
    def get_provider(self) -> AbstractCapability:
        ...
        from agentwolf_toolsets.entry_points import EntryPointTools
...
class ComposioToolSetConfig(BaseToolsetConfig):
    ...
    def get_provider(self) -> AbstractCapability:
        """Create provider from this config."""
        from agentwolf_toolsets.composio_toolset import ComposioTools
...
class ProcessManagementToolsetConfig(BaseToolsetConfig):
    ...
    def get_provider(self) -> AbstractCapability:
        ...
        from agentwolf_toolsets.builtin import ProcessManagementTools
...
class SkillsToolsetConfig(BaseToolsetConfig):
    ...
    def get_provider(self) -> AbstractCapability:
        ...
        from agentwolf_toolsets.builtin import SkillsTools
...
class CustomToolsetConfig(BaseToolsetConfig):
    ...
    def get_provider(self) -> AbstractCapability:
        ...
        from agentwolf.utils.importing import import_class
...
class MCPDiscoveryToolsetConfig(BaseToolsetConfig):
    ...
    Requires the `mcp-discovery` extra: `pip install agentwolf[mcp-discovery]`
    """
    ...
    def get_provider(self) -> AbstractCapability:
        ...
        from agentwolf_toolsets.mcp_discovery.toolset import MCPDiscoveryToolset
...
class CronToolsetConfig(BaseToolsetConfig):
    ...
    Requires the ``bot`` extra: ``pip install agentwolf[bot]``
    """
    ...
    store_path: str = Field(
        default="~/.agentwolf/cron_jobs.json",
        title="Job store path",
        examples=["~/.agentwolf/cron_jobs.json", "/tmp/cron.json"],
    )
    ...
    def get_provider(self) -> AbstractCapability:
        ...
        from agentwolf_toolsets.cron import CronTools
