...
if TYPE_CHECKING:
    from agentwolf.messaging.compaction import CompactionPipeline, CompactionStep
...
class FilterThinkingConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import FilterThinking
...
class FilterRetryPromptsConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import FilterRetryPrompts
...
class FilterBinaryContentConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import FilterBinaryContent
...
class FilterToolCallsConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import FilterToolCalls
...
class FilterEmptyMessagesConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import FilterEmptyMessages
...
class TruncateToolOutputsConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import TruncateToolOutputs
...
class TruncateTextPartsConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import TruncateTextParts
...
class KeepLastMessagesConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import KeepLastMessages
...
class KeepFirstMessagesConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import KeepFirstMessages
...
class KeepFirstAndLastConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import KeepFirstAndLast
...
class TokenBudgetConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import TokenBudget
...
class SummarizeConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import Summarize
...
class WhenMessageCountExceedsConfig(Schema):
    ...
    def build(self) -> CompactionStep:
        from agentwolf.messaging.compaction import WhenMessageCountExceeds
