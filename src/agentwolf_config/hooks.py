...
if TYPE_CHECKING:
    ...
    from agentwolf.hooks.base import Hook, HookEvent
...
class CommandHookConfig(BaseHookConfig):
    ...
    def get_hook(self, event: HookEvent) -> Hook:
        ...
        from agentwolf.hooks import CommandHook
...
class CallableHookConfig(BaseHookConfig):
    ...
    def get_hook(self, event: HookEvent) -> Hook:
        ...
        from agentwolf.hooks import CallableHook
...
class PromptHookConfig(BaseHookConfig):
    ...
    def get_hook(self, event: HookEvent) -> Hook:
        ...
        from agentwolf.hooks import PromptHook
