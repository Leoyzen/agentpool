...
APP_NAME: Final = "agentwolf"
APP_AUTHOR: Final = "agentwolf"
...
class FileStorageConfig(BaseStorageProviderConfig):
    ...
    def get_provider(self) -> StorageProvider:
        ...
        from agentwolf_storage.file_provider import FileProvider
...
class MemoryStorageConfig(BaseStorageProviderConfig):
    ...
    def get_provider(self) -> StorageProvider:
        ...
        from agentwolf_storage.memory_provider import MemoryStorageProvider
...
class ZedStorageConfig(BaseStorageProviderConfig):
    ...
    def get_provider(self) -> StorageProvider:
        ...
        from agentwolf_storage.zed_provider import ZedStorageProvider
...
class ACPStorageConfig(BaseStorageProviderConfig):
    ...
    def get_provider(self) -> StorageProvider:
        ...
        from agentwolf_storage.acp_provider import ACPStorageProvider
