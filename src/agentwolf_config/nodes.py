...
from agentwolf_config.event_handlers import EventHandlerConfig, StdoutEventHandlerConfig
from agentwolf_config.forward_targets import (
    FileConnectionConfig,
    ForwardingTarget,
    NodeConnectionConfig,
)
from agentwolf_config.hooks import HooksConfig
...
class NodeConfig(Schema):
    ...
    def get_event_handlers(self) -> list[IndividualEventHandler]:
        ...
        """
        from agentwolf_config.event_handlers import resolve_handler_configs
...
class BaseAgentConfig(NodeConfig):
    ...
    via :func:`agentwolf_config.team_mode.resolve_team_mode` to produce
    ...
    def parse_elicitation_timeout(cls, v: str | timedelta | float | None) -> timedelta | None:
        ...
        # to avoid importing from agentwolf (layer separation).
        import re
