"""Models for agentwolf standalone tool configuration."""
...
from agentwolf_config.converters import ConversionConfig  # noqa: TC001
from agentwolf_config.tools import BaseToolConfig
...
class BashToolConfig(BaseToolConfig):
    ...
    def get_tool(self) -> Tool:
        ...
        from agentwolf.tool_impls.bash import create_bash_tool
...
class AgentCliToolConfig(BaseToolConfig):
    ...
    def get_tool(self) -> Tool:
        ...
        from agentwolf.tool_impls.agent_cli import create_agent_cli_tool
...
class QuestionToolConfig(BaseToolConfig):
    ...
    def get_tool(self) -> Tool:
        ...
        from agentwolf.tool_impls.question import create_question_tool
...
class ExecuteCodeToolConfig(BaseToolConfig):
    ...
    def get_tool(self) -> Tool:
        ...
        from agentwolf.tool_impls.execute_code import create_execute_code_tool
...
# Union type for agentwolf tool configs
AgentpoolToolConfig = (
    AgentCliToolConfig
    | QuestionToolConfig
    | BashToolConfig
