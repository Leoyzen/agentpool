...
class StdoutEventHandlerConfig(BaseEventHandlerConfig):
    ...
    def get_handler(self) -> IndividualEventHandler:
        ...
        from agentwolf.agents.events import detailed_print_handler, simple_print_handler
...
class FileStreamEventHandlerConfig(BaseEventHandlerConfig):
    ...
    def get_handler(self) -> IndividualEventHandler:
        ...
        from agentwolf.agents.events.builtin_handlers import create_file_stream_handler
...
class TTSEventHandlerConfig(BaseEventHandlerConfig):
    ...
    def get_handler(self) -> IndividualEventHandler:
        ...
        from agentwolf.agents.events.tts_handlers import OpenAITTSEventHandler
...
class EdgeTTSEventHandlerConfig(BaseEventHandlerConfig):
    ...
    def get_handler(self) -> IndividualEventHandler:
        ...
        from agentwolf.agents.events.tts_handlers import EdgeTTSEventHandler
