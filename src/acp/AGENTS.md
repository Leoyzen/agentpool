...
Standalone JSON-RPC 2.0 protocol implementation for the Agent Communication Protocol (69 files). Independent from agentwolf framework -- used by it, not part of it.
...
- The debug server at `agent/implementations/debug_server/` provides a full standalone ACP agent + HTML UI for testing without agentwolf.
