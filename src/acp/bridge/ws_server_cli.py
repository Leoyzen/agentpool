...
Usage:
    python -m acp.bridge.ws_server_cli "uv run agentwolf serve-acp"
    python -m acp.bridge.ws_server_cli --port 8765 -- uv run agentwolf serve-acp
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            '  acp-ws-server "uv run agentwolf serve-acp"\n'
            "  acp-ws-server --port 8765 -- uv run agentwolf serve-acp\n"
