"""Configuration models for agentwolf_bot channels."""
...
if TYPE_CHECKING:
    from agentwolf_bot.bus import MessageBus
    from agentwolf_bot.channels.discord import DiscordChannel
    from agentwolf_bot.channels.email import EmailChannel
    from agentwolf_bot.channels.slack import SlackChannel
    from agentwolf_bot.channels.telegram import TelegramChannel
    from agentwolf_bot.channels.whatsapp import WhatsAppChannel
