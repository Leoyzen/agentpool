...
from agentwolf_bot.channels.base import BaseChannel
...
if TYPE_CHECKING:
    ...
    from agentwolf_bot.bus import MessageBus, OutboundMessage
    from agentwolf_bot.config import TelegramConfig
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"Hi {user.first_name}! I'm an agentwolf bot.\n\n"
    ...
    async def _on_message(  # noqa: PLR0915
        ...
        if media_file and self._app:
            try:
                ...
                media_dir = Path.home() / ".agentwolf" / "media"
                ...
                if media_type in ("voice", "audio"):
                    from agentwolf_bot.transcription import GroqTranscriptionProvider
