...
from agentwolf.mime_utils import detect_image_media_type
...
if TYPE_CHECKING:
    ...
    from agentwolf_storage.zed_provider.models import (
        ZedFlatMessage,
        ZedNestedMessage,
        ZedThread,
        ZedToolResult,
...
def thread_to_chat_messages(thread: ZedThread, thread_id: str) -> list[ChatMessage[str]]:
    ...
    """
    from agentwolf_storage.zed_provider.models import ZedFlatMessage, ZedNestedMessage
