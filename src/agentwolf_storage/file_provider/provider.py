...
from agentwolf.common_types import JsonValue, MessageRole
from agentwolf.log import get_logger
from agentwolf.messaging import ChatMessage, TokenCost
from agentwolf.storage import deserialize_messages
from agentwolf.utils.time_utils import get_now, parse_iso_timestamp
from agentwolf_config.storage import FileStorageConfig
from agentwolf_storage.base import StorageProvider
from agentwolf_storage.models import TokenUsage
...
if TYPE_CHECKING:
    ...
    from agentwolf.sessions.models import ProjectData
...
class FileProvider(StorageProvider):
    ...
    async def log_message(self, *, message: ChatMessage[Any]) -> None:
        """Log a new message."""
        from agentwolf.storage.serialization import serialize_messages
