...
from agentwolf.utils.thread_helpers import run_in_thread
from agentwolf.utils.time_utils import datetime_to_ms, get_now, ms_to_datetime, parse_iso_timestamp
...
from agentwolf_storage.models import ConversationData as ConvData, TokenUsage
from agentwolf_storage.opencode_provider import helpers


if TYPE_CHECKING:
    from agentwolf.messaging import ChatMessage, TokenCost
    from agentwolf_config.session import SessionQuery
    from agentwolf_storage.models import QueryFilters, StatsFilters
        ...
        *,
        ...
        if role == "assistant":
            oc_message = AssistantMessage(
                ...
                model_id=model or "",
                provider_id=model.split(":")[0] if model else "agentwolf",
