...
from agentwolf.utils.pydantic_ai_helpers import to_user_content
from agentwolf.utils.time_utils import ms_to_datetime
...
def compute_project_id(directory: str) -> str:
    ...
    !!! note "Dual ID scheme"
        ...
        ``agentwolf_storage.project_store``, which hashes the canonical worktree
