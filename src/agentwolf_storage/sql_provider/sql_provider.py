...
from agentwolf_storage.sql_provider.sql_messages import SQLMessagesMixin
from agentwolf_storage.sql_provider.sql_projects import SQLProjectsMixin
from agentwolf_storage.sql_provider.sql_sessions import SQLSessionsMixin
...
class SQLModelProvider(
    ...
    async def _init_database(self, auto_migrate: bool = True) -> None:
        ...
        """
        from agentwolf_storage.sql_provider.utils import run_alembic_migrations
