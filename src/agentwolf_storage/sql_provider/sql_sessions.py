...
if TYPE_CHECKING:
    ...
    from agentwolf.common_types import JsonValue
    from agentwolf.sessions.models import SessionData
    from agentwolf_storage.models import ConversationData, StatsFilters
...
class SQLSessionsMixin:
    ...
    async def get_session_stats(self, filters: StatsFilters) -> dict[str, dict[str, Any]]:
        ...
        from agentwolf_storage.sql_provider.models import Conversation, Message
    ...
    async def reset(self, *, agent_name: str | None = None, hard: bool = False) -> tuple[int, int]:
        ...
        from agentwolf_storage.sql_provider.queries import (
    ...
    async def get_session_counts(self, *, agent_name: str | None = None) -> tuple[int, int]:
        ...
        from agentwolf_storage.sql_provider import Conversation, Message
