#!/usr/bin/env python3
"""Database migration management script for agentwolf.
...
app = typer.Typer(
    name="agentwolf-db",
    help="Database migration management for agentwolf",
...
def get_project_root() -> Path:
    ...
    # This file is in src/agentwolf_storage/sql_provider/cli.py
