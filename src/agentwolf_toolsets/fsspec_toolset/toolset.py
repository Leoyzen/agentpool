...
from agentwolf.agents.context import AgentContext  # noqa: TC001
from agentwolf.capabilities.function_toolset import FunctionToolsetCapability
from agentwolf.log import get_logger
from agentwolf.mime_utils import guess_type, is_binary_content, is_binary_mime
from agentwolf.tool_impls.delete_path import create_delete_path_tool
from agentwolf.tool_impls.download_file import create_download_file_tool
from agentwolf.tool_impls.grep import create_grep_tool
from agentwolf.tool_impls.list_directory import create_list_directory_tool
from agentwolf.tool_impls.read import create_read_tool
from agentwolf.tools.base import ToolResult  # noqa: TC001
from agentwolf.utils.diffs import get_changed_line_numbers
from agentwolf_toolsets.fsspec_toolset.diagnostics import (
    DiagnosticsConfig,
    DiagnosticsManager,
    format_diagnostics_table,
)
from agentwolf_toolsets.fsspec_toolset.helpers import (
    format_directory_listing,
    truncate_lines,
)
from agentwolf_toolsets.fsspec_toolset.streaming_diff_parser import (
    NewTextChunk,
    OldTextChunk,
    StreamingDiffParser,
)
...
if TYPE_CHECKING:
    ...
    from agentwolf.common_types import ModelType
    ...
    from agentwolf_toolsets.fsspec_toolset.grep import GrepBackend
...
class FSSpecTools(FunctionToolsetCapability):
    ...
    async def _get_file_map(
        ...
        """
        from agentwolf.repomap import generate_file_outline
    ...
    async def list_directory(  # noqa: D417
        ...
        *,
        ...
        """
        from agentwolf.agents.events import TextContentItem
    ...
    async def read(  # noqa: D417
        ...
        """
        from agentwolf.agents.events import FileContentItem, LocationContentItem
        from agentwolf.repomap import truncate_with_notice
    ...
    async def write(  # noqa: D417
        ...
        """
        from agentwolf.agents.events import DiffContentItem
        from agentwolf.tools.base import ToolResult
    ...
    async def grep(  # noqa: D417
        ...
        *,
        ...
        """
        from agentwolf.agents.events import TextContentItem
        from agentwolf_toolsets.fsspec_toolset.grep import (
...
def to_opencode_edit_metadata(original_content: str, new_content: str, path: str) -> dict[str, Any]:
    from agentwolf.utils.diffs import compute_unified_diff
    ...
    async def main() -> None:
        ...
        async with AgentPool():
            ...
            result = await tools.agentic_edit(
                ...
                agent_ctx,
                path="/home/phil65/dev/oss/agentwolf/src/agentwolf_toolsets/fsspec_toolset/toolset.py",
