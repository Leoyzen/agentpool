...
async def get_platform_paths() -> str:
    """Get platform-specific paths for agentwolf.
    ...
    paths = {
        "config": platformdirs.user_config_dir("agentwolf"),
        "data": platformdirs.user_data_dir("agentwolf"),
        "cache": platformdirs.user_cache_dir("agentwolf"),
        "logs": platformdirs.user_log_dir("agentwolf"),
        "state": platformdirs.user_state_dir("agentwolf"),
    }

    lines = ["Platform paths for agentwolf:", ""]
