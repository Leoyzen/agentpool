...
from agentwolf.mcp_server.registries.official_registry_client import (
    MCPRegistryClient,
    MCPRegistryError,
)
...
if TYPE_CHECKING:
    ...
    from agentwolf.mcp_server.registries.official_registry_client import RegistryServer
