...
#
# ``.svg`` is intentionally excluded from byte-return candidates: it is a
# vector format most vision APIs reject. See ``VikingCapability._should_return_image_bytes``.
