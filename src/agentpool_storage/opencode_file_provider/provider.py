...
from agentpool_config.storage import OpenCodeFileStorageConfig
...
from agentpool_storage.opencode_file_provider import helpers
...
class OpenCodeFileStorageProvider(StorageProvider):
    ...
    def __init__(self, config: OpenCodeFileStorageConfig | None = None) -> None:
        """Initialize OpenCode file storage provider."""
        config = config or OpenCodeFileStorageConfig()
...
if __name__ == "__main__":
    ...
    async def main() -> None:
        provider = OpenCodeFileStorageProvider()
