...
from agentwolf_cli import agent_store, resolve_agent_config
from agentwolf_cli.common import verbose_opt
...
def init_agent_config(
    ...
    if interactive:
        from agentwolf.utils.inspection import validate_import
    ...
    print("\nTry these commands:")
    print("  agentwolf list")
    print("  agentwolf chat simple_agent")
...
def list_configs() -> None:
    ...
    if not configs:
        t.echo("No configurations stored. Use 'agentwolf add' to add one.")
        return
