...
def show_config(
    ...
    from agentwolf_config.resolution import get_config_search_paths, resolve_config
...
def init_config(
    ...
    from agentwolf_config.resolution import ensure_global_config_dir

    if location == "global":
        target = ensure_global_config_dir() / "agentwolf.yml"
    elif location == "project":
        target = Path.cwd() / "agentwolf.yml"
    else:
