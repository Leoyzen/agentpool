...
# Duplicated from agentwolf_config.pool_server to avoid heavy imports at CLI startup
TransportType = Literal["stdio", "sse", "streamable-http"]

if TYPE_CHECKING:
    from agentwolf import ChatMessage
...
def serve_command(
    ...
    async def run_server() -> None:
        ...
        from agentwolf_server.mcp_server.server import MCPServer
