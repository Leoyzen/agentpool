...
from agentwolf_cli import log
from agentwolf_cli.agent import add_agent_file, list_agents, list_configs, set_active_file
from agentwolf_cli.cli_types import LogLevel  # noqa: TC001
from agentwolf_cli.config_info import config_cli
from agentwolf_cli.history import history_cli
from agentwolf_cli.run import run_command
from agentwolf_cli.serve_acp import acp_command
from agentwolf_cli.serve_agui import agui_command
from agentwolf_cli.serve_api import api_command
from agentwolf_cli.serve_mcp import serve_command
from agentwolf_cli.serve_opencode import opencode_command
from agentwolf_cli.serve_vercel import vercel_command
from agentwolf_cli.store import ConfigStore
from agentwolf_cli.task import task_command
from agentwolf_cli.ui import ui_app
from agentwolf_cli.watch import watch_command
...
def version_callback(value: bool) -> None:
    ...
    if value:
        version = metadata.version("agentwolf")
        t.echo(f"agentwolf version {version}")
        raise t.Exit
