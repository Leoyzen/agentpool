    ...
    def __post_init__(self) -> None:
        ...
        for agent in self.agent_pool.all_agents.values():
            ...
            if isinstance(agent, Agent):
                ...
                agent.sys_prompts.prompts.append(self.get_cwd_context)  # ty: ignore[invalid-argument-type]
        ...
        try:
            ...
            for agent in self.agent_pool.get_agents(Agent).values():
                if self.get_cwd_context in agent.sys_prompts.prompts:
                    agent.sys_prompts.prompts.remove(self.get_cwd_context)  # ty: ignore[invalid-argument-type]
