...
from agentwolf.mcp_server import constants
...
if TYPE_CHECKING:
    ...
    from agentwolf_config.pool_server import MCPPoolServerConfig
...
agentwolf_dir = platformdirs.user_config_dir("agentwolf")

store = DiskStore(directory=agentwolf_dir)
