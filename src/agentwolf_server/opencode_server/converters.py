...
from agentwolf.utils.pydantic_ai_helpers import safe_args_as_dict, to_user_content_or_path_ref
from agentwolf.utils.time_utils import datetime_to_ms, ms_to_datetime
...
if TYPE_CHECKING:
    ...
    from agentwolf.common_types import MCPConnectionStatus, MCPServerStatus, PathReference
    from agentwolf.models.model_configs import AnyModelConfig
    from agentwolf_server.opencode_server.models import ToolState
    from agentwolf_server.opencode_server.models.mcp import (
        MCPConnectionStatus as OpenCodeMCPConnectionStatus,
    )
    from agentwolf_server.opencode_server.models.message import PartInput
...
def chat_message_to_opencode(  # noqa: PLR0915
    ...
    if msg.role == "user":
            ...
            for model_msg in msg.messages:
                ...
                for part in model_msg.parts:
                    ...
                    if isinstance(content, str):
                        ...
                        from agentwolf.agents.native_agent.helpers import _summarize_content_block
        ...
        if model_variants:
            from agentwolf_server.shared.model_utils import resolve_model_info_from_response
