...
from agentwolf_server.opencode_server.routes import (
    agent_router,
    app_router,
    config_router,
    file_router,
...
from agentwolf_server.opencode_server.todo_utils import build_opencode_todos
...
if TYPE_CHECKING:
    ...
    from agentwolf.storage.manager import SessionMetadataGeneratedEvent
...
async def check_pypi_version(package: str = "agentwolf") -> str | None:
...
def create_app(*, agent: BaseAgent[Any, Any], working_dir: str | None = None) -> FastAPI:  # noqa: PLR0915
    ...
    async def on_todo_change(tracker: TodoTracker) -> None:
        ...
        from agentwolf_server.opencode_server.models.events import Todo, TodoUpdatedEvent
    ...
    async def on_title_generated(event: SessionMetadataGeneratedEvent) -> None:
        ...
        from agentwolf_server.opencode_server.converters import opencode_to_session_data
        from agentwolf_server.opencode_server.models.events import SessionUpdatedEvent
    ...
    async def lifespan(app: FastAPI) -> AsyncIterator[None]:  # noqa: PLR0915
        ...
        from agentwolf.utils.file_watcher import FileWatcher, GitBranchWatcher
        ...
        async def check_for_updates() -> None:
            ...
            from agentwolf import __version__ as current_version
            from agentwolf_server.opencode_server.models.events import TuiToastShowEvent

            latest = await check_pypi_version("agentwolf")
            if latest and compare_versions(current_version, latest):
                ...
                event = TuiToastShowEvent.create(
                    ...
                    message=f"agentwolf {latest} is available (current: {current_version})",
                    variant="info",
                    duration=10000,
                )
                await state.broadcast_event(event)
...
if __name__ == "__main__":
    ...
    from agentwolf import AgentPool, config_resources
