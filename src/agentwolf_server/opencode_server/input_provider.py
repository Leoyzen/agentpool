...
if TYPE_CHECKING:
    from agentwolf.agents.context import AgentContext, ConfirmationResult
    from agentwolf_server.opencode_server.models import PermissionReply
    from agentwolf_server.opencode_server.models.question import QuestionInfo, QuestionRequest
...
class OpenCodeInputProvider(InputProvider):
    ...
    def get_pending_questions(self) -> list[QuestionRequest]:
        ...
        """
        from agentwolf_server.opencode_server.models.question import QuestionRequest
    ...
    async def _handle_single_enum(
        ...
        from agentwolf_server.opencode_server.state import PendingQuestion
    ...
    def _property_to_question(self, key: str, prop_schema: dict[str, Any]) -> QuestionInfo:
        ...
        """
        from agentwolf_server.opencode_server.models.question import (
            QuestionInfo,
            QuestionOption,
        )
