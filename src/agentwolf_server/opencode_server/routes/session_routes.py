...
from agentwolf.repomap import RepoMap, find_src_files
from agentwolf.utils import identifiers as identifier
from agentwolf.utils.identifiers import extract_timestamp_ms
from agentwolf.utils.time_utils import now_ms
from agentwolf_server.opencode_server.command_validation import validate_command
from agentwolf_server.opencode_server.converters import (
    chat_message_to_opencode,
    opencode_to_session_data,
    session_data_to_opencode,
)
from agentwolf_server.opencode_server.dependencies import StateDep
...
from agentwolf_server.opencode_server.stream_adapter import OpenCodeStreamAdapter
...
async def fork_session(  # noqa: D417
    ...
    if session_pool is not None:
        ...
        from agentwolf_server.opencode_server.converters import opencode_to_chat_message
...
async def summarize_session(  # noqa: PLR0915
    ...
    from agentwolf.messaging.compaction import compact_conversation, summarizing_context
...
async def revert_session(session_id: str, request: RevertRequest, state: StateDep) -> Session:  # noqa: PLR0915
    ...
    """
    from agentwolf_server.opencode_server.models import MessageRemovedEvent, PartRemovedEvent
