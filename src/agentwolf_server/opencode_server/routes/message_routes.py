...
if TYPE_CHECKING:
    ...
    from agentwolf.orchestrator.session_pool import SessionPool
    from agentwolf_server.opencode_server.session_pool_integration import (
...
async def _route_message_locked(  # noqa: PLR0915
    ...
    *,
    ...
    assistant_msg = AssistantMessage(
        ...
        provider_id=request.model.provider_id if request.model else "agentwolf",  # ty: ignore[invalid-argument-type]
        mode=agent_name,
        agent=agent_name,
