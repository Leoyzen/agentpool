"""ACP (Agent Client Protocol) server implementation for agentwolf.
...
from agentwolf_config.pool_server import ACPPoolServerConfig
...
class ACPServer(BaseServer):
    """ACP (Agent Client Protocol) server for agentwolf using external library.

    Provides a bridge between agentwolf's Agent system and the standard ACP
