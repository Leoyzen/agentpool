"""ACP (Agent Client Protocol) session management for agentwolf.
...
from agentwolf.commands.base import NodeCommand
from agentwolf.log import get_logger
from agentwolf_server.acp_server.input_provider import ACPInputProvider
from agentwolf_server.acp_server.session_agent_mgmt import ACPSessionAgentMgmtMixin
from agentwolf_server.acp_server.session_events import ACPSessionEventsMixin
from agentwolf_server.acp_server.session_lifecycle import ACPSessionLifecycleMixin
...
if TYPE_CHECKING:
    ...
    from agentwolf.common_types import PathReference
...
def get_all_commands() -> Sequence[BaseCommand]:
    ...
    with OpenCode, which does not register agentwolf_commands at all.
    """
    return []
