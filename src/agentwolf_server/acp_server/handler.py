...
from agentwolf.agents.events.events import ElicitationDeferredEvent, SpawnSessionStart
from agentwolf.log import get_logger
from agentwolf_server.acp_server.event_converter import ACPEventConverter, SubagentContext
from agentwolf_server.acp_server.input_provider import ACPInputProvider
from agentwolf_server.mixins import ConsumerShutdown, ProtocolEventConsumerMixin
...
class ACPProtocolHandler(ProtocolEventConsumerMixin):
    ...
    async def handle_prompt(  # noqa: PLR0915
        ...
        *,
        ...
        from agentwolf_server.acp_server.converters import from_acp_content
        ...
        if acp_session is not None:
            from agentwolf_server.acp_server.session import SLASH_PATTERN, split_commands
        ...
        from agentwolf_server.acp_server.event_converter import ACPUserMessageMeta
