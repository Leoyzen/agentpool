...
class ACPSessionLifecycleMixin:
    ...
    def _make_provider_name(self, display_name: str) -> str:
        ...
        from agentwolf_server.acp_server.session import _MAX_PROVIDER_NAME_LENGTH
            ...
            try:
                with anyio.fail_after(30):
                    ...
                    if isinstance(server, AcpMcpServer):
                        ...
                        from agentwolf_server.acp_server.acp_mcp_transport import (
                            AcpMcpTransport,
                        )
    ...
    async def process_prompt(self, content_blocks: Sequence[ContentBlock]) -> StopReason:  # noqa: PLR0911, PLR0915
        ...
        Returns:
            Stop reason
        """
        from agentwolf_server.acp_server.session import infer_stop_reason, split_commands
    ...
    async def _send_toast(
        ...
        *,
        ...
        Uses _agentwolf/toast ext notification instead of polluting chat
