...
from agentwolf.agents.events.events import ToastInfo
from agentwolf.agents.modes import ConfigOptionChanged, ModeInfo
from agentwolf.log import get_logger


if TYPE_CHECKING:
    from agentwolf.agents.base_agent import StateUpdate
...
class ACPSessionEventsMixin:
    ...
    async def _on_state_updated(self, state: StateUpdate) -> None:
        ...
        from agentwolf_server.acp_server.acp_agent import get_session_config_options
