...
from agentwolf.messaging.context import NodeContext  # noqa: TC001
from agentwolf_server.acp_server.session import ACPSession  # noqa: TC001
...
class DebugSetPoolCommand(NodeCommand):
    ...
    - A stored config name (from `agentwolf add`)
    ...
    async def execute_command(
        ...
        *,
        ...
        agent_store = importlib.import_module("agentwolf_cli").agent_store
