...
from agentwolf.utils.task_group import ManagedTaskGroup
from agentwolf_server.acp_server.acp_mcp_manager import AcpMcpConnectionManager
from agentwolf_server.acp_server.converters import to_session_config_option, to_session_info
...
async def get_session_mode_state(agent: BaseAgent) -> SessionModeState | None:
    ...
    Converts agentwolf ModeCategory to ACP SessionModeState format.
...
class AgentPoolACPAgent(ACPAgent):
    ...
    async def new_session(self, params: NewSessionRequest) -> NewSessionResponse:
        ...
        from agentwolf.agents.acp_agent import ACPAgent as ACPAgentClient
