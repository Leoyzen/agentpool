...
from agentwolf_server.shared.constants import (
...
if TYPE_CHECKING:
    ...
    from agentwolf_server.opencode_server.models import Provider
...
def resolve_model_info_from_response(
    ...
    with ``"unknown"`` / ``"agentwolf"`` defaults for ``None`` values.
    ...
    return model_name or "unknown", provider_name or "agentwolf"
