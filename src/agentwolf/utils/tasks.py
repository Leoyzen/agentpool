...
(see :mod:`agentwolf.utils.task_group`) or direct ``asyncio`` task
...
class TaskManager:
    ...
    Use :class:`agentwolf.utils.task_group.ManagedTaskGroup` for structured
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        msg = (
            ...
            "(agentwolf.utils.task_group) or MessageNode.spawn_task() instead."
        )
