...
from agentwolf.prompts.builtin_provider import BuiltinPromptProvider


if TYPE_CHECKING:
    from agentwolf.agents.staged_content import StagedContent
    from agentwolf.prompts.base import BasePromptProvider
    from agentwolf_config.system_prompts import PromptLibraryConfig, StaticPromptConfig
