...
from agentwolf.utils import importing
...
class DynamicPrompt(BasePrompt):
    ...
    def from_callable(
        ...
        *,
        ...
        from agentwolf.utils.inspection import get_fn_qualname
...
class MCPClientPrompt(BasePrompt):
    ...
    async def get_components(
        ...
        """
        from agentwolf.mcp_server.conversions import content_block_as_text
