...
from agentwolf.repomap.utils import MIN_TOKEN_SAMPLE_SIZE, get_rel_path
...
class RepoMap:
    ...
    TAGS_CACHE_DIR: ClassVar[str] = f".agentwolf.tags.cache.v{CACHE_VERSION}"
    ...
    async def _info(self, path: str) -> FileInfo | None:
        """Get file info."""
        from agentwolf.repomap.types import FileInfo
    ...
    async def get_map_with_metadata(
        ...
        *,
        ...
        Args:
            ...
            boost_idents: Identifiers to boost in ranking.
        """
        from agentwolf.repomap.types import RepoMapResult
