...
Capability-Native Architecture (M3 Todo 11):
    ...
    Entry-Point Discovery (M3 Todo 12):
        ...
        ``agentwolf.capabilities`` entry-point group. The discovered
...
if TYPE_CHECKING:
    ...
    from agentwolf.agents.native_agent import Agent as NativeAgent
    from agentwolf.capabilities.change_event import ChangeEvent
...
class AgentFactory:
    ...
    def entry_point_capabilities(self) -> dict[str, type[AbstractCapability[object]]]:
        ...
        ``agentwolf.capabilities`` entry-point group. Populated by
        ``compile()``.
        """
    ...
    def compile(
        ...
        ``agentwolf.capabilities`` entry-point group and stores them
        ...
        """
        from agentwolf.capabilities.registry import discover_entry_point_capabilities
        from agentwolf.host.registry import AgentRegistry
    ...
    def _compile_agent_capabilities(
        ...
        """
        from agentwolf.capabilities.subagent_capability import SubagentCapability
        from agentwolf.models.agents import NativeAgentConfig
        ...
        from agentwolf_config.team_mode import resolve_team_mode
        ...
        # deprecated; McpServerCap (agentwolf.capabilities.mcp_server_cap)
        ...
        from agentwolf.capabilities.combined_toolset import _NamedCapability
    ...
    def _has_subagent_toolset(self, cfg: AnyAgentConfig) -> bool:
        ...
        """
        from agentwolf_config.toolsets import SubagentToolsetConfig
    ...
    def resolve_capability_type(
        ...
        """
        from agentwolf.capabilities.registry import resolve_capability_type
    ...
    async def create_session_agent(
        ...
        if caps:
            from agentwolf.agents.native_agent import Agent as _NativeAgent
        ...
        if resolved_tm is not None and resolved_tm.enabled:
            eligible = resolved_tm.lead_eligible + resolved_tm.member_eligible
            if agent_name in eligible:
                from agentwolf.agents.native_agent import Agent as _NativeAgent2
                from agentwolf.capabilities.team_comm_capability import TeamCommCapability
    ...
    async def _create_native_child(
        ...
        *,
        ...
        from agentwolf.agents.native_agent import Agent as _NativeAgent
        from agentwolf.mcp_server.config_snapshot import (
            McpConfigSnapshot,
        )
    ...
    async def _start_hot_swap_listeners(
        ...
        """
        from agentwolf.capabilities.combined_toolset import (
            _NamedCapability,
            _OnChangeCapable,
        )
