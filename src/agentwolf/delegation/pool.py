...
from agentwolf.capabilities.combined_toolset import CombinedToolsetCapability, _NamedCapability
from agentwolf.capabilities.extension_registry import ExtensionRegistry
from agentwolf.capabilities.resource_protocols import SkillResource
from agentwolf.delegation.message_flow_tracker import MessageFlowTracker
...
from agentwolf.tasks import TaskRegistry
...
if TYPE_CHECKING:
    ...
    from agentwolf_config.session_pool import SessionPoolConfig
...
class AgentPool[TPoolDeps = None]:
    ...
    def __init__(  # noqa: PLR0915
        ...
        **kwargs: Any,
        ...
        from agentwolf.vfs_registry import VFSRegistry
        from agentwolf_config.context import ConfigContextManager
        from agentwolf_toolsets.builtin.debug import install_memory_handler
        ...
        with ConfigContextManager(config_path):
            ...
            from agentwolf_config.forward_targets import NodeConnectionConfig
        ...
        async with self._enter_lock:
            try:
                ...
                if team_mode is not None and team_mode.enabled:
                    from agentwolf.capabilities.file_team_state import (
...
if __name__ == "__main__":
    ...
    async def main() -> None:
        path = "src/agentwolf/config_resources/agents.yml"
