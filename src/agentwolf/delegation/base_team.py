...
from agentwolf.agents.events import SpawnSessionStart, SubAgentEvent
from agentwolf.agents.exceptions import MAX_DELEGATION_DEPTH, DelegationDepthError
from agentwolf.log import get_logger
from agentwolf.messaging import AgentResponse, ChatMessage, MessageNode, TeamResponse
from agentwolf.messaging.context import NodeContext
from agentwolf.messaging.messagenode import get_source_type
from agentwolf.messaging.processing import finalize_message, prepare_prompts
from agentwolf.talk.stats import AggregatedMessageStats
...
if TYPE_CHECKING:
    ...
    from agentwolf.delegation.graph_team import ExtendedTeamTalk
    from agentwolf.talk.stats import AggregatedTalkStats
    from agentwolf.ui.base import InputProvider
    from agentwolf_config.mcp_server import MCPServerConfig
    from agentwolf_config.teams import ExecutionMode, TeamMemberConfig
...
class BaseTeam[TDeps, TResult](MessageNode[TDeps, TResult]):
    ...
    async def execute_iter(
        ...
        **kwargs: Any,
        ...
        from agentwolf.delegation.graph_team import _make_sequential_step, _TeamRunGraphState
    ...
    async def _execute_parallel(
        ...
        **kwargs: Any,
        ...
        from agentwolf.delegation.graph_team import _TeamGraphState, run_team_graph
    ...
    async def _execute_sequential(
        ...
        **kwargs: Any,
        ...
        from agentwolf.delegation.graph_team import run_teamrun_graph
    ...
    async def _run_stream_parallel(
        ...
        **kwargs: Any,
        ...
        from agentwolf.common_types import SupportsRunStream
        from agentwolf.utils.identifiers import generate_session_id
...
if __name__ == "__main__":
    ...
    async def main() -> None:
        from agentwolf import Agent, BaseTeam
