...
- A lightweight test harness for running end-to-end tests against the agentwolf
...
async def acp_test_session(
    ...
    *,
    ...
    """Create an end-to-end ACP test session using agentwolf as server.

    This context manager starts an ACPAgent connected to a agentwolf serve-acp
