...
class ExtensionRegistry:
    ...
    def get_tool_access(
        ...
        """
        from agentwolf.capabilities.resource_protocols import ToolAccess
    ...
    def get_resource_template_access(
        ...
        """
        from agentwolf.capabilities.resource_protocols import ResourceTemplateAccess
    ...
    def get_command_resources(
        ...
        """
        from agentwolf.capabilities.resource_protocols import CommandResource
    ...
    def get_observable_capabilities(
        ...
        """
        from agentwolf.capabilities.resource_protocols import ChangeObservable
    ...
    async def resolve_uri(
        ...
        if uri.startswith("skill://"):
            ...
            from agentwolf.skills.skill import Skill
            from agentwolf.skills.uri_resolver import ResolvedSkillURI, _name_alternatives
        ...
        if uri.startswith("mcp://"):
            from agentwolf.capabilities.resource_protocols import TextResourceContent
