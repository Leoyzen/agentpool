...
from agentwolf.capabilities.modality_utils import (
    BinaryCategory,
...
class ModalityFilterCapability(AbstractCapability[Any]):
    ...
    def get_ordering(self) -> CapabilityOrdering | None:
        ...
        pruning.
        """
        from agentwolf.capabilities.dcp.capability import (
            DynamicContextPruningCapability,
        )
        from agentwolf.capabilities.tool_output_budget import (
