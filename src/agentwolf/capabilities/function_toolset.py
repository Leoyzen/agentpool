...
if TYPE_CHECKING:
    ...
    from agentwolf import Agent, MessageNode
    from agentwolf.capabilities.change_event import ChangeEvent
    from agentwolf.common_types import ToolSource, ToolType
...
class FunctionToolsetCapability(AbstractCapability[AgentDepsT]):
    """Wraps a static list of :class:`~agentwolf.tools.base.Tool` instances.

    Provides:
    - ``get_toolset()``: eagerly builds a ``FunctionToolset`` from the
      wrapped tools via :func:`~agentwolf.tools.tool_wrapping.wrap_tool_for_pydantic_ai`.
    ...
    def create_tool(
        ...
        from agentwolf.tools.base import Tool as ToolClass
        from agentwolf_config.tools import ToolHints
    ...
    def get_toolset(self) -> AgentToolset[AgentDepsT] | None:
        ...
        :func:`~agentwolf.tools.tool_wrapping.wrap_tool_for_pydantic_ai`,
        ...
        from agentwolf.tools.tool_wrapping import wrap_tool_for_pydantic_ai
