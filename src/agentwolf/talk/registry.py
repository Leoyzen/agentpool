...
from agentwolf.utils.baseregistry import AgentPoolError, BaseRegistry


if TYPE_CHECKING:
    from agentwolf import MessageNode
    from agentwolf.messaging import ChatMessage
    from agentwolf.talk.stats import TalkStats
    from agentwolf_config.conditions import ConnectionCondition
