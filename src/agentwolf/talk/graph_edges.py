...
:class:`~agentwolf.talk.Talk` instances into ``pydantic-graph``
...
from agentwolf.utils.inspection import is_async_callable
...
class TalkEdgeTranslator:
    """Translates :class:`~agentwolf.talk.Talk` connections into graph edges.
