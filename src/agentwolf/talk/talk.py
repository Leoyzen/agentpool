...
from agentwolf.talk.stats import AggregatedTalkStats, TalkStats
from agentwolf.utils.inspection import execute
...
if TYPE_CHECKING:
    ...
    from agentwolf.messaging.events import ConnectionEventData
    from agentwolf_config.events import ConnectionEventType
...
class Talk[TTransmittedData = Any]:
    ...
    def __rshift__(
        ...
        from agentwolf.talk import TeamTalk
    ...
    async def _evaluate_condition(
        ...
        *,
        ...
        from agentwolf.talk.registry import EventContext
