...
from agentwolf.utils.count_tokens import batch_count_tokens


if TYPE_CHECKING:
    from datetime import datetime

    from agentwolf.common_types import MessageRole
    from agentwolf.messaging.messages import FormatStyle
    from agentwolf.utils.dag import DAGNode
...
class ChatMessageList(EventedList[ChatMessage[Any]]):
    ...
    def to_mermaid_graph(
        ...
        *,
        ...
        from agentwolf.utils.dag import dag_to_list
