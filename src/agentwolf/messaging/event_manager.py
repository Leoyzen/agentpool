...
from agentwolf.utils.inspection import execute, get_fn_name
...
if TYPE_CHECKING:
    ...
    from agentwolf.agents.events import RichAgentStreamEvent, SubAgentEvent
...
class EventManager:
    ...
    async def emit_agent_event(
        ...
        """
        from agentwolf.agents.events import SubAgentEvent
