...
from agentwolf.talk import AggregatedTalkStats, Talk, TeamTalk
...
if TYPE_CHECKING:
    ...
    from agentwolf.common_types import AgentName, AnyTransformFn, AsyncFilterFn, QueueStrategy
    from agentwolf.messaging import ChatMessage, MessageNode
