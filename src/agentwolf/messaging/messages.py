...
from agentwolf.common_types import MessageRole, SimpleJsonType  # noqa: TC001
from agentwolf.log import get_logger
from agentwolf.utils.inspection import dataclasses_no_defaults_repr
...
class ChatMessage[TContent]:
    ...
    def get_tool_calls(
        ...
        """
        from agentwolf.tools import ToolCallInfo
    ...
    def get_token_count(self) -> int:
        ...
        from agentwolf.utils.count_tokens import count_tokens
