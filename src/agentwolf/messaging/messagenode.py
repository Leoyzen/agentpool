...
from agentwolf.talk import AggregatedTalkStats
...
if TYPE_CHECKING:
    ...
    from agentwolf.talk import Talk, TeamTalk
    from agentwolf.talk.stats import AggregatedMessageStats, MessageStats
    from agentwolf.tools.base import FunctionTool
    from agentwolf.ui.base import InputProvider
    from agentwolf_config.forward_targets import ConnectionType
...
class MessageNode[TDeps, TResult](ABC):
    ...
    def __init__(
        ...
        from agentwolf.messaging import EventManager
    ...
    def _build_single_node_graph(
        ...
        """
        from agentwolf.messaging.graph_adapter import MessageNodeStep
