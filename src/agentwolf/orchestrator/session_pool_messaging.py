...
from agentwolf.lifecycle.types import DeliveryMode, Feedback
...
if TYPE_CHECKING:
    ...
    from agentwolf.orchestrator.session_controller import SessionController, SessionState
        ...
        **metadata: Any,
        ...
        Raises:
            ...
            Exception: Any error from the agent run is re-raised after
                session cleanup.
        """
        from agentwolf.agents.events import RunErrorEvent
