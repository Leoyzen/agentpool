...
from agentwolf.orchestrator.runtime_registry import RuntimeAgentRegistry
...
if TYPE_CHECKING:
    ...
    from agentwolf.lifecycle.protocols import (
        CommChannel,
        EventTransport,
        Journal,
        SnapshotStore,
    ...
    from agentwolf.lifecycle.types import Feedback, ResumeResult
    from agentwolf.models.pending_interaction import PendingPermission
...
class SessionState:
    ...
    def set_current_run_id(self, run_id: str | None) -> None:
        ...
        from agentwolf.agents.events import StateUpdate
        from agentwolf.lifecycle.types import RunState
...
from agentwolf.orchestrator.session_controller_agent import (  # noqa: E402
    SessionControllerAgentMixin,
)
from agentwolf.orchestrator.session_controller_close import (  # noqa: E402
    SessionControllerCloseMixin,
)
from agentwolf.orchestrator.session_controller_runs import SessionControllerRunsMixin  # noqa: E402
