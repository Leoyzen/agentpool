...
from agentwolf.lifecycle.comm_channel import ProtocolChannel
from agentwolf.log import get_logger
from agentwolf.observability.spans import safe_span
from agentwolf.orchestrator.run import RunHandle, inject_cancelled_tool_results
...
class SessionControllerRunsMixin:
    ...
    def _start_run_handle(
        ...
        *,
        ...
        tracer = otel_trace.get_tracer("agentwolf.run")
