...
from agentwolf_server.opencode_server.models.session_info import SessionInfo
    ...
    async def _get_or_create_session_locked(
        ...
        **metadata: Any,
        ...
        Returns:
            ...
            if the session was newly created, False if it already existed.
        """
        from agentwolf.orchestrator.session_controller import SessionLifecyclePolicy
