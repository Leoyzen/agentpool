...
from agentwolf.orchestrator.session_controller import (
...
from agentwolf.orchestrator.session_pool_config import SessionPoolConfig
...
if TYPE_CHECKING:
    ...
    from agentwolf.agents.native_agent.checkpoint import CheckpointData
    from agentwolf.delegation import AgentPool
    from agentwolf.messaging import ChatMessage
    from agentwolf.sessions.models import ElicitationResumePayload, PendingDeferredCall, SessionData
...
from agentwolf.orchestrator.session_pool_messaging import SessionPoolMessagingMixin  # noqa: E402
from agentwolf.orchestrator.session_pool_runs import SessionPoolRunsMixin  # noqa: E402
from agentwolf.orchestrator.session_pool_teams import SessionPoolTeamsMixin  # noqa: E402
...
class SessionPool(
    ...
    async def create_child_session(
        ...
        **metadata: Any,
        ...
        :func:`agentwolf.utils.identifiers.generate_session_id` when not
        provided.
    ...
    async def _resume_native_agent(  # noqa: PLR0915
        ...
        if session_data.agent_config_hash:
            try:
                from agentwolf.agents.native_agent.checkpoint import (
        ...
        if elicitation_payloads:
            ...
            from agentwolf.ui.elicitation import normalize_elicit_content
