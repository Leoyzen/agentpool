...
if TYPE_CHECKING:
    ...
    from agentwolf.lifecycle.protocols import CommChannel
...
class RunHandle:
    ...
    async def _execute_turn(  # noqa: PLR0915
        ...
        if session.input_provider is not None:
            from agentwolf.mcp_server.manager import _current_input_provider
    ...
    def steer(
        ...
        *,
        ...
        """
        from agentwolf.lifecycle.types import Feedback
