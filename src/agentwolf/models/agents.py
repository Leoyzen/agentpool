...
from agentwolf.common_types import EndStrategy  # noqa: TC001
from agentwolf.models.fields import OutputTypeField, SystemPromptField  # noqa: TC001
from agentwolf.models.model_configs import AnyModelConfig  # noqa: TC001
from agentwolf.prompts.prompts import PromptMessage, StaticPrompt
from agentwolf_config import BaseToolConfig, NativeAgentToolConfig
from agentwolf_config.builtin_tools import BaseBuiltinToolConfig
from agentwolf_config.knowledge import Knowledge  # noqa: TC001
from agentwolf_config.nodes import BaseAgentConfig
from agentwolf_config.session import MemoryConfig, SessionQuery
from agentwolf_config.toolsets import BaseToolsetConfig, ToolsetConfig
from agentwolf_config.workers import WorkerConfig  # noqa: TC001
...
if TYPE_CHECKING:
    ...
    from agentwolf.common_types import AnyEventHandlerType
    from agentwolf.delegation import AgentPool
    from agentwolf.prompts.prompts import BasePrompt
    from agentwolf.tools.base import Tool
    from agentwolf.ui.base import InputProvider
    from agentwolf_config.workers import AgentWorkerConfig
...
class NativeAgentConfig(BaseAgentConfig):
    ...
    model: AnyModelConfig | ModelId | str = Field(
        ...
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/model_configuration/"
        },
    )
    ...
    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/model_configuration/
    """
    ...
    tools: Sequence[AnyToolConfig | str] = Field(
        ...
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/tool_configuration/"
        },
    )
    ...
    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/tool_configuration/
    """
    ...
    session: str | SessionQuery | MemoryConfig | None = Field(
        ...
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/session_configuration/"
        },
    )
    """Session configuration for conversation recovery.

    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/session_configuration/
    """
    ...
    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/system_prompts_configuration/
    """
    ...
    knowledge: Knowledge | None = Field(
        ...
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/knowledge_configuration/"
        },
    )
    """Knowledge sources for this agent.

    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/knowledge_configuration/
    """
    ...
    workers: list[WorkerConfig] = Field(
        ...
        title="Worker agents",
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/worker_configuration/"
        },
    )
    """Worker agents which will be available as tools.

    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/worker_configuration/
    """
    ...
    def handle_capabilities(cls, data: dict[str, Any]) -> dict[str, Any]:
        ...
        2. **Entry-point name** (e.g. ``"mermaid_lint"``) → wrapped in
           ...
           ``agentwolf.capabilities`` entry-point group.
            ...
            for cap in capabilities:
                if isinstance(cap, dict):
                    ...
                    if is_known_capability_type(raw_type):
                        ...
                        if ep_names is None:
                            try:
                                from agentwolf.capabilities.registry import (
