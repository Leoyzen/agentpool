...
from agentwolf_config.system_prompts import PromptConfig
...
SystemPromptField = Annotated[
    ...
    Field(
        ...
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/system_prompts_configuration/"
        },
