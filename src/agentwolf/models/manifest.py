...
from agentwolf import log
from agentwolf.models.acp_agents import ACPAgentConfigTypes
from agentwolf.models.agents import NativeAgentConfig
from agentwolf.models.file_agents import FileAgentConfig
from agentwolf.models.model_configs import AnyModelConfig, StringModelConfig
from agentwolf_config.commands import CommandConfig, StaticCommandConfig
from agentwolf_config.compaction import CompactionConfig
from agentwolf_config.context import ConfigContextManager
from agentwolf_config.converters import ConversionConfig
from agentwolf_config.graph_config import GraphConfig
from agentwolf_config.graph_translation import translate_config_to_graph
from agentwolf_config.mcp_server import BaseMCPServerConfig, MCPServerConfig
from agentwolf_config.observability import ObservabilityConfig
from agentwolf_config.output_types import StructuredResponseConfig
from agentwolf_config.pool_server import ACPPoolServerConfig, MCPPoolServerConfig
from agentwolf_config.session_pool import ACPConfig, OpenCodeConfig, SessionPoolConfig
from agentwolf_config.skills import SkillsConfig
from agentwolf_config.storage import StorageConfig
from agentwolf_config.system_prompts import PromptLibraryConfig
...
if TYPE_CHECKING:
    ...
    from agentwolf.messaging.compaction import CompactionPipeline
    from agentwolf.models.acp_agents import BaseACPAgentConfig
    from agentwolf_config.nodes import NodeConfig
...
class AgentsManifest(Schema):
    ...
    agents: dict[str, AnyAgentConfig] = Field(
        default_factory=dict,
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/agent_configuration/"
        },
    )
    ...
    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/agent_configuration/
    """
    ...
    teams: dict[str, TeamConfig] = Field(
        default_factory=dict,
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/team_configuration/"
        },
    )
    """Mapping of team IDs to their configurations.

    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/team_configuration/
    """
    ...
    storage: StorageConfig = Field(
        ...
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/storage_configuration/"
        },
    )
    """Storage provider configuration.

    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/storage_configuration/
    """
    ...
    responses: dict[str, StructuredResponseConfig] = Field(
        default_factory=dict,
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/response_configuration/"
        },
    )
    """Mapping of response names to their definitions.

    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/response_configuration/
    """
    ...
    mcp_servers: list[str | MCPServerConfig] = Field(
        ...
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/mcp_configuration/"
        },
    )
    ...
    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/mcp_configuration/
    """
    ...
    prompts: PromptLibraryConfig = Field(
        ...
        json_schema_extra={
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/prompt_configuration/"
        },
    )
    ...
    Docs: https://phil65.github.io/agentwolf/YAML%20Configuration/prompt_configuration/
    """
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={
            ...
            "documentation_url": "https://phil65.github.io/agentwolf/YAML%20Configuration/manifest_configuration/",
            "patternProperties": {
    ...
    def _loaded_file_agents(self) -> dict[str, NativeAgentConfig]:
        ...
        """
        from agentwolf.models.file_parsing import parse_file_agent_reference
    ...
    def from_resolved(
        ...
        *,
        ...
        """
        from agentwolf_config.resolution import resolve_config
...
if __name__ == "__main__":
    from agentwolf.models.model_configs import InputModelConfig
