...
Provides Pydantic-based model configurations for agentwolf agents.
"""
...
class StringModelConfig(BaseModelConfig):
    ...
    def get_model(self) -> Model:
        from agentwolf.utils.model_helpers import _get_openai_based_model, infer_model
...
class TestModelConfig(BaseModelConfig):
    ...
    def get_model(self) -> Any:
        if self.tool_args:
            from agentwolf.models.fixed_args_test_model import FixedArgsTestModel
...
class AnthropicModelConfig(BaseModelConfig):
    ...
    def get_model(self) -> Any:
        if self.auth_method == "oauth":
            ...
            from agentwolf.auth.anthropic_auth import (
