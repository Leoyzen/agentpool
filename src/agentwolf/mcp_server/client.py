...
from agentwolf.mcp_server.constants import MCP_TO_LOGGING
from agentwolf.mcp_server.helpers import extract_text_content, mcp_tool_to_fn_schema
from agentwolf.mcp_server.message_handler import MCPMessageHandler
from agentwolf.tools import CallDeferred
from agentwolf.tools.base import FunctionTool
from agentwolf.utils.signatures import create_modified_signature
...
class MCPClient:
    ...
    async def call_tool(  # noqa: PLR0915
        ...
        from agentwolf.mcp_server.conversions import from_mcp_content
...
if __name__ == "__main__":
    path = "/home/phil65/dev/oss/agentwolf/tests/mcp_server/server.py"
