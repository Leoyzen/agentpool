...
from agentwolf.lifecycle.types import ResumeResult, ToolExecutionRecord
...
if TYPE_CHECKING:
    ...
    from agentwolf.lifecycle.protocols import SnapshotStore
...
from agentwolf.agents.events.events import (  # noqa: E402
