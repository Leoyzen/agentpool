...
from agentwolf.agents.events import ToolCallCompleteEvent, UserMessageInsertedEvent
...
def _summarize_content_block(block: Any) -> str:
    ...
    if isinstance(
        ...
        from agentwolf.capabilities.modality_utils import describe_multimodal_content
