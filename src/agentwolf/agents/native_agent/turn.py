...
from agentwolf.agents.native_agent.helpers import extract_text_from_messages
from agentwolf.log import get_logger
from agentwolf.messaging import ChatMessage
from agentwolf.messaging.messages import TokenCost
from agentwolf.observability.spans import safe_span
from agentwolf.orchestrator.event_mapper import (
    EventMapper,
...
from agentwolf.tools.base import is_terminal_tool
from agentwolf.utils.pydantic_ai_helpers import flatten_prompts
from agentwolf.utils.usage import diff_usage
...
class NativeTurn(HookAwareTurn, Turn):
    ...
    async def execute(self) -> AsyncGenerator[RichAgentStreamEvent[Any]]:  # noqa: PLR0915, PLR0911
        ...
        with safe_span(
            ...
            from agentwolf.observability.trace import get_trace_id
