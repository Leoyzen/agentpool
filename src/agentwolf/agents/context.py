...
if TYPE_CHECKING:
    ...
    from agentwolf.agents.events import StreamEventEmitter
    from agentwolf.agents.native_agent.checkpoint import CheckpointManager
    from agentwolf.agents.native_agent.elicitation_bridge import ElicitationFutureRegistry
...
class AgentContext[TDeps = Any](NodeContext[TDeps]):
    ...
    async def report_progress(self, progress: float, total: float | None, message: str) -> None:
        ...
        from agentwolf.agents.events import ToolCallProgressEvent
    ...
    async def create_child_session(
        ...
        **metadata: Any,
        ...
        if self.run_ctx is not None:
            ...
            from agentwolf.agents.events.events import SpawnSessionStart
