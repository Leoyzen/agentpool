...
from agentwolf.agents.context import AgentContext, AgentRunContext
from agentwolf.agents.events import (
    RunErrorEvent,
    StreamCompleteEvent,
    resolve_event_handlers,
)
from agentwolf.agents.modes import ModeInfo
from agentwolf.capabilities.function_toolset import FunctionToolsetCapability
from agentwolf.common_types import IndividualEventHandler
from agentwolf.log import get_logger
from agentwolf.messaging import ChatMessage, MessageHistory, MessageNode
from agentwolf.observability.spans import safe_span
from agentwolf.prompts.convert import convert_prompts
from agentwolf.utils.inspection import call_with_context
...
if TYPE_CHECKING:
    ...
    from agentwolf.agents.modes import ConfigOptionChanged, ModeCategory, ModeCategoryId
    ...
    from agentwolf.orchestrator.core import EventBus, SessionPool, SessionState
    ...
    from agentwolf.talk.stats import MessageStats
    from agentwolf.ui.base import InputProvider
    from agentwolf_config.lifecycle import LifecycleConfig
...
class BaseAgent[TDeps = None, TResult = str](MessageNode[TDeps, TResult]):
    ...
    def __init__(
        ...
        *,
        ...
        from agentwolf.agents.staged_content import StagedContent
        from agentwolf_commands import get_commands
    ...
    async def update_state(self, config_id: str, value_id: str) -> None:
        from agentwolf.agents.modes import ConfigOptionChanged
    ...
    async def get_resource(self, name: str) -> Any:
        ...
        from agentwolf.capabilities.resource_protocols import ResourceAccess
    ...
    async def list_prompts(self) -> list[Any]:
        ...
        from agentwolf.capabilities.extension_registry import Scope, ScopeLevel
        from agentwolf.capabilities.function_toolset import FunctionToolsetCapability
        from agentwolf.prompts.prompts import MCPClientPrompt as MCPPrompt
    ...
    async def _temporary_tools(
        ...
        *,
        ...
        """
        from agentwolf.tools.base import Tool as ToolClass
    ...
    def _maybe_pool_stream(
        ...
        *,
        ...
        from agentwolf.utils.identifiers import generate_session_id
    ...
    async def run_stream(  # type: ignore[override]  # noqa: PLR0915
        ...
        **pydantic_ai_kwargs: Any,
        ...
        if self._lifecycle_config is not None and not self._lifecycle_config.is_all_defaults():
            from agentwolf.lifecycle.factory import create_dimensions
    ...
    async def _execute_slash_command_streaming(
        ...
        from agentwolf.agents.events import CommandCompleteEvent, CommandOutputEvent
    ...
    async def load_rules(self, project_dir: str | None = None) -> None:
        ...
        1. Global: ~/.config/agentwolf/AGENTS.md (user-wide rules)
        ...
        """
        from agentwolf_config.resolution import get_global_config_dir
