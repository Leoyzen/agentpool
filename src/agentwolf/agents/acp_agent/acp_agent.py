...
ACP-compatible agent into the agentwolf pool.
...
Example:
    ```python
    from agentwolf.models.acp_agents import ACPAgentConfig
...
from agentwolf.agents.acp_agent.turn import ACPClientProtocol, ACPTurn
...
from agentwolf.agents.events.processors import event_to_part
from agentwolf.agents.exceptions import (
...
from agentwolf.utils.subprocess_utils import SubprocessError, run_with_process_monitor
from agentwolf.utils.token_breakdown import calculate_usage_from_parts
...
if TYPE_CHECKING:
    ...
    from agentwolf.agents.acp_agent.client_handler import ACPClientHandler
...
class ACPAgent[TDeps = None](BaseAgent[TDeps, str]):
    ...
    This allows integrating any ACP-compatible agent into the agentwolf
    ...
    def __init__(
        ...
        *,
        ...
        from agentwolf.mcp_server.tool_bridge import ToolManagerBridge
        ...
        # ACP initialization
        self._init_request = init_request or InitializeRequest.create_for_package("agentwolf")
        # Tools
    ...
    async def _create_session(self) -> None:
        ...
        from agentwolf.agents.acp_agent.acp_converters import mcp_config_to_acp
        from agentwolf.agents.acp_agent.helpers import filter_servers_by_capabilities
    ...
    async def _stream_events(  # noqa: PLR0915  # type: ignore[override]
        ...
        **pydantic_ai_kwargs: Any,
        ...
        from agentwolf.agents.acp_agent.acp_converters import to_finish_reason
    ...
    async def get_modes(self) -> list[ModeCategory]:
        ...
        from agentwolf.agents.acp_agent.acp_converters import get_modes
    ...
    async def load_session(self, session_id: str) -> SessionData | None:
        ...
        from agentwolf.agents.acp_agent.acp_converters import (
