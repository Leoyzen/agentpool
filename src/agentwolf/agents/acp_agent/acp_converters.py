...
This module provides conversion from ACP session updates to native agentwolf
...
if TYPE_CHECKING:
    ...
    from agentwolf.agents.events import RichAgentStreamEvent, ToolCallContentItem
...
def mcp_config_to_acp(config: MCPServerConfig) -> McpServer:
    ...
    Args:
        config: agentwolf MCP server configuration
