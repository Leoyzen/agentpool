...
if TYPE_CHECKING:
    from agentwolf_commands.text_sharing import TextSharerStr, Visibility
...
class ShareHistoryCommand(NodeCommand):
    ...
    async def execute_command(
        ...
        *,
        ...
        """
        from agentwolf_commands.text_sharing import get_sharer
...
class GetLogsCommand(NodeCommand):
    ...
    async def execute_command(
        ...
        *,
        ...
        """
        from agentwolf_toolsets.builtin.debug import get_memory_handler
