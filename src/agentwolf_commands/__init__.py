...
from agentwolf_commands.agents import (
    CreateAgentCommand,
    CreateTeamCommand,
    ListAgentsCommand,
    ShowAgentCommand,
...
from agentwolf_commands.connections import (
    ConnectCommand,
    DisconnectCommand,
    ListConnectionsCommand,
    DisconnectAllCommand,
)
from agentwolf_commands.history import SearchHistoryCommand
from agentwolf_commands.mcp import (
    AddMCPServerCommand,
    AddRemoteMCPServerCommand,
    ListMCPServersCommand,
)
from agentwolf_commands.models import SetModelCommand
from agentwolf_commands.prompts import ListPromptsCommand, ShowPromptCommand
from agentwolf_commands.resources import (
    ListResourcesCommand,
    ShowResourceCommand,
    AddResourceCommand,
)
from agentwolf_commands.session import ClearCommand, ResetCommand
from agentwolf_commands.read import ReadCommand
from agentwolf_commands.tools import (
    DisableToolCommand,
    EnableToolCommand,
    ListToolsCommand,
...
from agentwolf_commands.workers import AddWorkerCommand, RemoveWorkerCommand, ListWorkersCommand
from agentwolf_commands.utils import (
    CopyClipboardCommand,
    EditAgentFileCommand,
    GetLogsCommand,
    ShareHistoryCommand,
)
from agentwolf_commands.pool import ListPoolsCommand, SpawnCommand
...
from agentwolf_commands.pool import CompactCommand  # noqa: F401
