...
class ListPoolsCommand(NodeCommand):
    ...
    async def execute_command(self, ctx: CommandContext[NodeContext[Any]]) -> None:
        ...
        """
        from agentwolf_cli import agent_store
        ...
        try:
            ...
            if not stored_configs:
                ...
                output_lines.append("")
                output_lines.append("Use `agentwolf add <name> <path>` to add configurations.")
            else:
    ...
    async def execute_command(
        ...
        *,
        ...
        try:
            ...
            from agentwolf.messaging.compaction import compact_conversation
