...
from agentwolf_commands.base import NodeCommand
from agentwolf_commands.completers import get_available_agents, get_available_nodes
...
class CreateTeamCommand(NodeCommand):
    ...
    async def execute_command(
        ...
        *nodes: str,
        ...
        # Create the team
        from agentwolf.delegation.base_team import BaseTeam as TeamClass
