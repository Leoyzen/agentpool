...
class FakeMcpResource(FakeCapability):
    ...
    async def call_tool(self, name: str, args: dict[str, Any]) -> Any:
        from agentwolf.capabilities.resource_protocols import ToolResult

        return ToolResult(content="tool result")

    async def list_resources(self) -> list[Any]:
        from agentwolf.capabilities.resource_protocols import ResourceEntry
...
class FakeCommandResource(FakeCapability):
    ...
    async def list_commands(self) -> list[Any]:
        from agentwolf.capabilities.resource_protocols import CommandEntry
...
class FakeResourceTemplateAccess(FakeCapability):
    ...
    async def list_resource_templates(self) -> list[Any]:
        from agentwolf.capabilities.resource_protocols import ResourceTemplateEntry
    ...
    async def complete_resource_template(
        ...
        from agentwolf.capabilities.resource_protocols import CompletionResult
