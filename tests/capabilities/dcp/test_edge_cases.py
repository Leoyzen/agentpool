...
from agentwolf.capabilities.dcp.block_store import CompressionBlockStore
...
from agentwolf.capabilities.dcp.strategies import _is_pruned, _prune_part
from agentwolf.capabilities.tool_output_budget import ToolOutputBudgetCapability
...
async def test_protected_pattern_matches_nothing_all_prunable() -> None:
    ...
    from agentwolf.capabilities.dcp.prunable_list import build_prunable_list
...
def test_dynamic_context_type_raises_error() -> None:
    ...
    from agentwolf_config.capabilities import is_known_capability_type
