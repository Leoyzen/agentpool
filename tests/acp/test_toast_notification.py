...
from agentwolf.agents.events import ToastInfo
...
class TestClientHandlerToast:
    ...
    async def test_handle_toast_notification(self, mock_handler):
        """Test handling _agentwolf/toast ext notification."""
        ...
        await ACPClientHandler.ext_notification(mock_handler, "_agentwolf/toast", params)
