...
from agentwolf_server.openai_api_server.completions.models import ChatCompletionRequest
from agentwolf_server.openai_api_server.responses.helpers import handle_request
from agentwolf_server.openai_api_server.responses.models import (
    ResponseMessage,
...
def test_non_streaming_completion_includes_reasoning_content():
    ...
    from agentwolf_server.openai_api_server.completions.models import OpenAIMessage
