...
class TestRouteModuleImports:
    ...
    @pytest.mark.parametrize(
        "module_name",
        [
            "agentwolf_server.opencode_server.routes.config_routes",
            "agentwolf_server.opencode_server.routes.agent_routes",
            "agentwolf_server.opencode_server.routes.global_routes",
            "agentwolf_server.opencode_server.routes.pty_routes",
        ],
    )
