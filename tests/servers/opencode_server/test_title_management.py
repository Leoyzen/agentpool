...
from agentwolf.storage.manager import SessionMetadata, SessionMetadataGeneratedEvent, StorageManager
...
from agentwolf_server.opencode_server.models.message import MessageRequest, TimeCreated
from agentwolf_server.opencode_server.routes.message_routes import (
    _maybe_generate_title,
)
from agentwolf_server.opencode_server.session_pool_integration import get_messages_for_session
...
class TestTitleGenerationDoesNotBlockAgent:
    ...
    async def test_run_message_locked_returns_fast_despite_slow_title(
        ...
        with (
            patch(
                "agentwolf_server.opencode_server.routes.message_routes._maybe_generate_title",
                slow_maybe_generate_title,
            ),
            patch(
                "agentwolf_server.opencode_server.routes.message_routes.extract_user_prompt_from_parts",
                new=AsyncMock(return_value=["hello"]),
            ),
            patch(
                "agentwolf_server.opencode_server.routes.message_routes.OpenCodeStreamAdapter"
