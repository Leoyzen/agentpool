...
from agentwolf_server.opencode_server.models.app import ProjectTime
...
from agentwolf_server.opencode_server.models.parts import Part, TextPart
from agentwolf_server.opencode_server.models.pty import PtyInfo
...
def test_session_id_properties_base_class_hierarchy() -> None:
    ...
    """
    from agentwolf_server.opencode_server.models.events import SessionErrorProperties
...
async def test_global_health_endpoint_fields(async_client: AsyncClient) -> None:
    ...
    from agentwolf_server.opencode_server.routes.global_routes import VERSION
