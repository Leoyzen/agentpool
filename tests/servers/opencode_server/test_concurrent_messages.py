...
from agentwolf_server.opencode_server.routes.message_routes import _process_message
        ...
        **kwargs: Any,
        ...
        async def stream() -> AsyncIterator[Any]:
            try:
                ...
                from agentwolf.agents.events import StreamCompleteEvent, TextContentItem
...
class TestConcurrentMessageHandling:
    ...
    async def test_concurrent_messages_same_session_should_be_sequential(
        ...
        from agentwolf_server.opencode_server.models.events import SessionErrorEvent
