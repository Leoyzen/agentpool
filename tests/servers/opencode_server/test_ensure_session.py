...
from agentwolf_server.opencode_server.session_pool_integration import ensure_session
...
async def test_ensure_session_creates_new_session(mock_state: ServerState) -> None:
    ...
    with patch(
        "agentwolf_server.opencode_server.converters.opencode_to_session_data"
    ) as mock_converter:
