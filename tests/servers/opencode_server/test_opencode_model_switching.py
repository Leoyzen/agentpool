...
in OpenCode TUI are not reflected in agentwolf runtime.
"""
...
from agentwolf import Agent, AgentPool, AgentsManifest
...
from agentwolf_server.opencode_server.models.config import Config
...
async def test_opencode_model_flow_simulation():
    ...
    This test simulates:
    1. OpenCode TUI connects to agentwolf
