...
async def test_summarize_uses_session_pool(
    ...
    from agentwolf.agents.events import PartDeltaEvent, PartStartEvent, StreamCompleteEvent
    ...
    with (
        patch(
            "agentwolf.messaging.compaction.compact_conversation",
            new=AsyncMock(),
        ),
        patch(
            "agentwolf_server.opencode_server.routes.session_routes.get_messages_for_session",
