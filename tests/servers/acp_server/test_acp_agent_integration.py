"""Integration tests for ACPAgent connecting to real agentwolf ACP server.

These tests spawn an actual agentwolf serve-acp process with a TestModel
...
def acp_agent_config(test_config_file: Path) -> ACPAgentConfig:
    """Create ACPAgentConfig that spawns agentwolf serve-acp."""
...
async def test_acp_agent_with_input_provider(acp_agent_config: ACPAgentConfig):
    ...
    from agentwolf.ui.stdlib_provider import StdlibInputProvider
