...
from agentwolf.messaging.messagenode import SourceType, get_source_type
...
def test_get_source_type_unknown_subclass_defaults_to_agent() -> None:
    ...
    with patch("agentwolf.messaging.messagenode.logger"):
...
def test_circular_import_safety() -> None:
    ...
    mod = importlib.import_module("agentwolf.messaging.messagenode")
    ...
    importlib.import_module("agentwolf.delegation.base_team")
