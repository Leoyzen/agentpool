...
from agentwolf_cli.__main__ import cli
from agentwolf_cli.agent import agent_cli
...
def setup_environment():
    ...
    # Disable logging
    logging.getLogger("agentwolf").setLevel(logging.CRITICAL)
    logging.getLogger("yamling").setLevel(logging.CRITICAL)

    # Mock ConfigStore
    with mock.patch("agentwolf_cli.agent.agent_store") as mock_store:
...
@mock.patch("agentwolf_cli.agent.agent_store")
