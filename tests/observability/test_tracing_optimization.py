...
class TestOtelLogProcessor:
    ...
    def test_calls_logfire_log_without_creating_span(self):
        ...
        from agentwolf.log import _otel_log_processor
        ...
        with patch("agentwolf.log.logfire") as mock_logfire:
    ...
    def test_returns_event_dict_unchanged(self):
        ...
        with patch("agentwolf.log.logfire"):
...
class TestObservabilityConfig:
    ...
    def test_new_fields_exist_with_correct_defaults(self):
        ...
        from agentwolf_config.observability import CustomObservabilityConfig
...
class TestObservabilityRegistry:
    ...
    def test_is_configured_returns_false_before_configuration(self):
        ...
        from agentwolf.observability.observability_registry import (
    ...
    def test_conditional_instrumentation(self):
        ...
        from agentwolf_config.observability import (
        ...
        registry = ObservabilityRegistry()
        with (
            patch("agentwolf.observability.observability_registry.logfire") as mock_lf,
            patch("agentwolf.observability.observability_registry._setup_otel_environment"),
        ):
