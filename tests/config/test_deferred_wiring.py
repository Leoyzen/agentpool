...
class TestCheckpointConfigWiring:
    ...
    def test_session_pool_config_with_checkpoint_enabled(self):
        ...
        from agentwolf_config.durable import CheckpointConfig
        from agentwolf_config.session_pool import SessionPoolConfig
...
class TestDeferredToolConfigExists:
    ...
    def test_deferred_tool_config_importable(self):
        """DeferredToolConfig can be imported from agentwolf_config.durable."""
        from agentwolf_config.durable import DeferredToolConfig
