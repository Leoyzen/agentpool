"""Tests for CallDeferred and ApprovalRequired re-exports from agentwolf.tools.
...
from agentwolf.tools import ApprovalRequired, CallDeferred
...
def test_both_in_agentwolf_tools_all():
    """Both exceptions should be listed in agentwolf.tools.__all__."""
    from agentwolf import tools
