...
def test_acp_adapter_satisfies_protocol() -> None:
    ...
    from agentwolf.agents.acp_agent.turn import ACPClientProtocol
    ...
    import agentwolf.agents.acp_agent.acp_agent as acp_module
    ...
    from agentwolf.agents.acp_agent.client_handler import TimeoutableEvent
...
def test_acp_turn_uses_run_ctx_run_id() -> None:
    ...
    import agentwolf.agents.acp_agent.turn as turn_module
