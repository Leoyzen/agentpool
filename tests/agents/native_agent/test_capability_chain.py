...
async def test_deferred_bridge_before_approval_bridge(
    ...
    with (
        patch(
            "agentwolf.agents.native_agent.deferred_bridge.create_deferred_bridge_capability",
        ) as mock_create_deferred,
        patch(
            "agentwolf.agents.native_agent.elicitation_bridge.create_elicitation_bridge_capability",
        ) as mock_create_elicitation,
        patch(
            "agentwolf.agents.native_agent.approval_bridge.create_approval_bridge_capability",
        ) as mock_create_approval,
        patch(
            "agentwolf.agents.native_agent.agent.PydanticAgent",
