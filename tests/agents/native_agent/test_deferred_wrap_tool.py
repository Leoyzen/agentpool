...
from agentwolf.tools import ApprovalRequired, CallDeferred, Tool
...
async def test_deferred_tool_catches_call_deferred_on_resume(
    ...
    from agentwolf.agents.native_agent import tool_wrapping as tw_mod
...
async def test_handle_deferred_exception_re_raises_call_deferred(
    ...
    from agentwolf.agents.native_agent.tool_wrapping import _handle_deferred_exception
