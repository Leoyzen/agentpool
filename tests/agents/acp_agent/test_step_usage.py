...
from agentwolf.agents.acp_agent.acp_converters import acp_to_native_event
from agentwolf.agents.acp_agent.turn import ACPTurn
from agentwolf.agents.context import AgentRunContext
from agentwolf.agents.events import StepUsageEvent
...
class _MockACPClient:
    ...
    Implements the :class:`~agentwolf.agents.acp_agent.turn.ACPClientProtocol`
