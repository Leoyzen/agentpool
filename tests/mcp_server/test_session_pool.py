...
from agentwolf.mcp_server.session_pool import (
...
async def test_get_transport_sse_caches(
    ...
    with patch("agentwolf.mcp_server.session_pool._create_transport", return_value=fake):
...
async def test_different_skill_names_get_different_transports(
    ...
    with patch(
        "agentwolf.mcp_server.session_pool._create_transport",
...
async def test_copy_pre_created_transports_copies_acp_only(
    ...
    from agentwolf.mcp_server.session_pool import _SessionConnection
