...
def _setup_agentwolf_logging() -> None:
    """Ensure agentwolf loggers are configured for test capture.

    Resets structlog to a minimal configuration and sets the agentwolf
    ...
    agentwolf_root = logging.getLogger("agentwolf")
    agentwolf_root.setLevel(logging.DEBUG)
    agentwolf_root.propagate = True
...
async def test_discover_skills_logging(
    ...
    from agentwolf_config import skills
