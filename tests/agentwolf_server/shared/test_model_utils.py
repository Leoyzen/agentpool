...
from agentwolf_server.opencode_server.models import ModelCost, ModelLimit
...
class TestExtractProvider:
    ...
    def test_anthropic_config(self) -> None:
        ...
        from agentwolf.models.model_configs import AnthropicModelConfig
    ...
    def test_openai_config(self) -> None:
        ...
        from agentwolf.models.model_configs import OpenAIModelConfig
    ...
    def test_gemini_config(self) -> None:
        ...
        from agentwolf.models.model_configs import GeminiModelConfig
    ...
    def test_fallback_config_first_string(self) -> None:
        ...
        from agentwolf.models.model_configs import FallbackModelConfig, StringModelConfig
    ...
    def test_fallback_config_first_anthropic(self) -> None:
        ...
        from agentwolf.models.model_configs import AnthropicModelConfig, FallbackModelConfig
    ...
    def test_fallback_config_empty_models(self) -> None:
        ...
        from agentwolf.models.model_configs import FallbackModelConfig
...
class TestApplyConfiguredVariants:
    ...
    def sample_provider(self) -> Any:
        ...
        from agentwolf_server.opencode_server.models import Model, Provider
...
class TestResolveModelInfoFromResponse:
    ...
    def test_none_provider_name(self) -> None:
        """Return (model_name, 'agentwolf') when provider_name is None."""
        result = resolve_model_info_from_response("gpt-4o", None, {})
        assert result == ("gpt-4o", "agentwolf")

    def test_both_none(self) -> None:
        """Return ('unknown', 'agentwolf') when both inputs are None."""
        result = resolve_model_info_from_response(None, None, {})
        assert result == ("unknown", "agentwolf")
