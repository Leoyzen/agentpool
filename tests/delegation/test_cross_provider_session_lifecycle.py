...
from agentwolf import Agent, AgentPool, AgentsManifest, BaseTeam
...
async def test_acp_child_session_inherits_parent_project_and_cwd() -> None:
    ...
    with (
        patch("agentwolf_server.acp_server.session_manager.ACPSession") as mock_session_cls,
        patch("agentwolf_server.acp_server.session_manager.ClientCapabilities"),
    ):
