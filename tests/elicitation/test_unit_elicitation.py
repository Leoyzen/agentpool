...
from agentwolf.agents.events.events import ElicitationDeferredEvent
...
from agentwolf.agents.native_agent.elicitation_strategy import (
    CheckpointResolutionStrategy,
    ElicitationResolutionStrategy,
    ProtocolResolutionStrategy,
)
from agentwolf.sessions.models import ElicitationResumePayload, PendingDeferredCall
from agentwolf.tools import CallDeferred
...
async def test_call_tool_raises_call_deferred(agent_ctx: AgentContext) -> None:
    ...
    from agentwolf.mcp_server.client import MCPClient
    ...
    with (
        patch(
            "agentwolf.mcp_server.conversions.from_mcp_content",
...
async def test_bridge_handles_elicitation_and_passthrough(run_ctx: RunContext[Any]) -> None:
    ...
    with patch(
        "agentwolf.agents.native_agent.elicitation_bridge._emit_elicitation_event",
...
def test_acp_input_provider_supports_durable_elicitation() -> None:
    ...
    from agentwolf_server.acp_server.input_provider import ACPInputProvider
...
async def test_handle_elicitation_updates_session_status_to_checkpointed(
    ...
    from agentwolf.sessions.models import ElicitationResumePayload, SessionData
