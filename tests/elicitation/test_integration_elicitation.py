...
from agentwolf.orchestrator.core import SessionClosedError
from agentwolf.sessions.models import (
...
async def test_opencode_processor_creates_toolpart_for_elicitation_event() -> None:
    ...
    from agentwolf_server.opencode_server.models.parts import ToolStateRunning
