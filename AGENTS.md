...
agentwolf run <name> "prompt"           # Run agent
agentwolf serve-acp config.yml          # Start ACP server
```
...
- Use `TYPE_CHECKING` blocks to avoid circular imports. Config models import from `agentwolf_config.*`, not `agentwolf.models`.
...
- `src/agentwolf/delegation/pool.py` — AgentPool orchestration
- `src/agentwolf/agents/agent.py` — Native agent implementation
- `src/agentwolf/messaging/messagenode.py` — MessageNode base abstraction
- `src/agentwolf/orchestrator/core.py` — EventBus, SessionController
- `src/agentwolf/orchestrator/run.py` — RunHandle (RunLoop) lifecycle
- `src/agentwolf/models/manifest.py` — Configuration schema
- `src/agentwolf/capabilities/` — Capability system (M3)
- `src/agentwolf/lifecycle/` — Lifecycle dimensions (M2)

## Context Loading

| Working on | Read this |
|---|---|
| RunLoop / Turn / EventBus | `src/agentwolf/orchestrator/AGENTS.md` |
| Lifecycle dimensions | `src/agentwolf/lifecycle/AGENTS.md` |
| Capabilities / tools | `src/agentwolf/capabilities/AGENTS.md` |
| Skills system | `src/agentwolf/skills/AGENTS.md` |
| Hooks system | `src/agentwolf/hooks/AGENTS.md` |
| Tests | `tests/AGENTS.md` |
| Protocol servers | `src/agentwolf_server/AGENTS.md` |
| ACP protocol | `src/acp/AGENTS.md` |
| Core framework overview | `src/agentwolf/AGENTS.md` |
...
| Extending AgentPool | `docs/explanation/extending-agentwolf.md` |
