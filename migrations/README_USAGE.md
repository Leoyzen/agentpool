# Database Migrations for agentwolf

This directory contains Alembic migrations for the agentwolf database schema.
...
2. Default: `sqlite:///./agentwolf.db` (configured in `alembic.ini`)
...
1. Make the change in `src/agentwolf_storage/sql_provider/models.py`
