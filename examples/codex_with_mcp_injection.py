...
async def example_integration_with_agentwolf():
    ...
    mcp_config = {"agentwolf-tools": {"type": "http", "url": "http://localhost:8765/mcp"}}
...
if __name__ == "__main__":
    ...
    # asyncio.run(example_integration_with_agentwolf())
