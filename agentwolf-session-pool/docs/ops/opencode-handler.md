...
Operational runbook for the `OpenCodeProtocolHandler` (`agentwolf_server.opencode_server.handler`).
...
4. **Verify SSE broadcast is working:**
   ```python
   from agentwolf_server.opencode_server.models.events import SessionIdleEvent
