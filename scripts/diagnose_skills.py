...
async def diagnose(config_path: str | None = None) -> None:  # noqa: PLR0915
    ...
    from agentwolf_config.skills import DEFAULT_SKILLS_PATHS
                        ...
                        try:
                            ...
                            if content.startswith("---"):
                                ...
                                if end != -1:
                                    ...
                                    from agentwolf.skills.skill import SkillMetadata
...
5. Check server logs with:
   OBSERVABILITY_ENABLED=true agentwolf serve-opencode config.yml
