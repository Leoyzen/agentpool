...
1. [Current AgentPool Lifecycle](#1-current-agentwolf-lifecycle)
...
|---|---|---|---|
| **AgentPool** | Python | `/packages/agentwolf/` | Unified agent orchestration, YAML config, multi-protocol |
...
### AgentPool
- `src/agentwolf/delegation/pool.py` — AgentPool entry/exit lifecycle
- `src/agentwolf/orchestrator/run.py` — RunHandle idle/wake/turn loop
- `src/agentwolf/orchestrator/turn.py` — Turn ABC + HookAwareTurn mixin
- `src/agentwolf/orchestrator/session_pool.py` — SessionPool
- `src/agentwolf/orchestrator/session_controller.py` — SessionController
- `src/agentwolf/orchestrator/event_bus.py` — EventBus
- `src/agentwolf/orchestrator/event_mapper.py` — EventMapper
- `src/agentwolf/agents/base_agent.py` — BaseAgent
- `src/agentwolf/agents/context.py` — AgentRunContext + AgentContext
- `src/agentwolf/agents/native_agent/turn.py` — NativeTurn
- `src/agentwolf/agents/acp_agent/turn.py` — ACPTurn
- `src/agentwolf/agents/native_agent/agent.py` — Native Agent
- `src/agentwolf/agents/prompt_injection.py` — PromptInjectionManager
- `src/agentwolf_server/mixins.py` — ProtocolEventConsumerMixin
- `src/agentwolf/mcp_server/manager.py` — MCPManager
