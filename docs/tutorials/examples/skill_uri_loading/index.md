...
```bash
# List available skills
agentwolf run skill_uri_loading/skill_lister "List all available skills"

# Load a skill by short name
agentwolf run skill_uri_loading/skill_loader "Load the greeting skill"

# Load with arguments
agentwolf run skill_uri_loading/skill_loader 'Load greeting with "Alice Company formal"'

# Load by full URI
agentwolf run skill_uri_loading/skill_loader "Load skill://local/greeting"
```
