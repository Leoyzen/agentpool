...
1. **Code-level verification** of AgentPool schema definitions in `packages/agentwolf/src/acp/schema/`
2. **Protocol interface audit** of `packages/agentwolf/src/acp/agent/protocol.py` and `packages/agentwolf/src/acp/client/protocol.py`
3. **Server implementation review** of `packages/agentwolf/src/agentwolf_server/acp_server/`
...
- `src/agentwolf_server/acp_server/acp_agent.py:843` — Implementation is `stop_session()`
...
```python
# src/agentwolf_server/acp_server/acp_agent.py:875-898
...
- `src/agentwolf_server/acp_server/provider_router.py` — Full provider management logic
...
The spec defines `mcp/connect`, `mcp/message`, `mcp/disconnect` for tunneling MCP through ACP. AgentPool has MCP server support (`src/agentwolf/mcp_server/`) but no MCP-over-ACP bridge.
...
**Schema Definitions:**
- `packages/agentwolf/src/acp/schema/base.py` — Base models, `_meta` handling
- `packages/agentwolf/src/acp/schema/messages.py` — `AgentMethod`, `ClientMethod` enums
- `packages/agentwolf/src/acp/schema/client_requests.py` — All client→agent request types
- `packages/agentwolf/src/acp/schema/agent_responses.py` — All agent→client response types
- `packages/agentwolf/src/acp/schema/session_updates.py` — Session update notification types
- `packages/agentwolf/src/acp/schema/tool_call.py` — Tool call types, `ToolCallLocation`
- `packages/agentwolf/src/acp/schema/client_responses.py` — Client response types, terminal
- `packages/agentwolf/src/acp/schema/elicitation.py` — Elicitation types
- `packages/agentwolf/src/acp/schema/providers.py` — Provider types
- `packages/agentwolf/src/acp/schema/capabilities.py` — Capability flags
- `packages/agentwolf/src/acp/schema/notifications.py` — Notification types

**Protocol Interfaces:**
- `packages/agentwolf/src/acp/agent/protocol.py` — Agent-side protocol interface
- `packages/agentwolf/src/acp/client/protocol.py` — Client-side protocol interface

**Server Implementation:**
- `packages/agentwolf/src/agentwolf_server/acp_server/acp_agent.py` — ACP agent protocol implementation
- `packages/agentwolf/src/agentwolf_server/acp_server/provider_router.py` — Provider management
- `packages/agentwolf/src/acp/bridge/bridge.py` — ACP bridge (stdio → HTTP)
