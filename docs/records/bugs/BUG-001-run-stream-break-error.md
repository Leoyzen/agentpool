...
**File**: `/Users/yuchen.liu/src/yilab/iroot-llm/packages/agentwolf/src/agentwolf/agents/native_agent/agent.py`
...
`/Users/yuchen.liu/src/yilab/iroot-llm/packages/agentwolf/tests/test_break_behavior.py`
...
1. **merge_queue_into_iterator** (`/Users/yuchen.liu/src/yilab/iroot-llm/packages/agentwolf/src/agentwolf/utils/streams.py`)
...
| File | Lines | Purpose |
|------|-------|---------|
| `agentwolf/agents/native_agent/agent.py` | 808-895 | Native agent stream with GeneratorExit handling |
| `agentwolf/agents/native_agent/agent.py` | 829-845 | merge_queue_into_iterator usage |
| `agentwolf/utils/streams.py` | ~ | merge_queue_into_iterator implementation |
| `agentwolf/agents/base_agent.py` | 566-648 | run_stream() top-level loop |
...
1. **`src/agentwolf/utils/streams.py`**: Enhanced `merge_queue_into_iterator` with:
...
2. **`src/agentwolf/agents/native_agent/agent.py`**: Refactored `_stream_events()` to:
