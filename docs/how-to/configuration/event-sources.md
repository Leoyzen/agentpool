...
sync:
  ...
  dependencies:
    - src/agentwolf_config/events.py
title: Event Sources
...
/// mknodes
{{ "agentwolf_config.events.EventConfig" | union_to_markdown(display_mode="yaml", header_style="pymdownx") }}
///
...
/// mknodes
{{ "agentwolf_config.events.ConnectionEventConditionType" | union_to_markdown(display_mode="yaml", header_style="pymdownx") }}
///
