...
/// mknodes
{{ "agentwolf_config.hooks.HooksConfig" | schema_to_markdown(display_mode="yaml", header_style="pymdownx") }}
///

## Hook Types

/// mknodes
{{ "agentwolf_config.hooks.HookConfig" | union_to_markdown(display_mode="yaml", header_style="pymdownx") }}
///
