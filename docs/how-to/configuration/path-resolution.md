...
sync:
  ...
  dependencies:
    - src/agentwolf_config/paths.py
    - src/agentwolf_config/context.py
...
agentwolf serve-acp agents.yml  # ./skills relative to CWD
```
...
agentwolf serve-acp /home/user/project/agents.yml  # ./skills relative to config dir
```
