...
sync:
  ...
  dependencies:
    - src/agentwolf_config/observability.py
title: Observability
...
/// mknodes
{{ "agentwolf_config.observability.ObservabilityProviderConfig" | union_to_markdown(display_mode="yaml", header_style="pymdownx") }}
///
