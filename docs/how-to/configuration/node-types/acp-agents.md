...
sync:
  ...
  dependencies:
    - src/agentwolf/models/acp_agents.py
title: ACP Agents
...
/// mknodes
{{ "agentwolf.models.acp_agents.ACPAgentConfigTypes" | union_to_markdown(display_mode="yaml", header_style="pymdownx", as_listitem=False, wrapped_in="agentname") }}
///
