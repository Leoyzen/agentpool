...
if TYPE_CHECKING:
    from agentwolf_toolsets.builtin.combined_toolset import CombinedToolsetCapability
...
| `agentwolf_commands/utils.py` | 2 | `manifest.config_file_path` → `ctx.config_file_path` |
