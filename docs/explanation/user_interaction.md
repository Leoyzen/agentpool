...
### StdlibInputProvider
**Location**: `agentwolf/ui/stdlib_provider.py`  
**Usage**: CLI, fallback  
**Mechanism**: Blocking `input()` calls  
**Limitations**: No async, no rich UI, no multi-select

### ACPInputProvider  
**Location**: `agentwolf_server/acp_server/input_provider.py`  
...
**Location**: `agentwolf_server/opencode_server/input_provider.py`  
...
### MockInputProvider
**Location**: `agentwolf/ui/mock_provider.py`  
**Usage**: Tests  
