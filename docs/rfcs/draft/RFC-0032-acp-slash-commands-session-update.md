...
**File**: `src/agentwolf_server/acp_server/acp_agent.py`
...
| `src/agentwolf_server/acp_server/acp_agent.py` | Remove `slash_commands=skill_commands` from `initialize()` |
...
- `src/agentwolf_server/acp_server/acp_agent.py:482-505` — `AgentPoolACPAgent.initialize()`
- `src/agentwolf_server/acp_server/session.py:562-572` — `ACPSession.send_available_commands_update()`
