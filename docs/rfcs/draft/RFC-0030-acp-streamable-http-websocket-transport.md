...
- [ ] ACP server can be started with `agentwolf serve-acp config.yml --transport streamable-http --port 8080` and accepts WebSocket connections at `/acp`
...
```
agentwolf serve-acp config.yml                                      # Default: stdio transport
agentwolf serve-acp config.yml --transport streamable-http          # WebSocket on localhost:8080
agentwolf serve-acp config.yml --transport streamable-http --port 9000   # WebSocket on localhost:9000
agentwolf serve-acp config.yml --transport streamable-http --host 0.0.0.0 --port 9000  # WebSocket on 0.0.0.0:9000
```
...
The `ACPPoolServerConfig` model in `src/agentwolf_config/pool_server.py` is extended with:
...
ACP server: `src/agentwolf_server/acp_server/server.py`
Pool server config: `src/agentwolf_config/pool_server.py`
