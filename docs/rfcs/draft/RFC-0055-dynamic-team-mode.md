...
- GitHub Discussion #160 (Leoyzen/agentwolf) documents the architectural proposal and received community feedback
...
from agentwolf.capabilities.abstract_capability import AbstractCapability
...
- **Deliverables**:
  ...
  - `agentwolf_config/team_mode.py` — Config model
  - `agentwolf_config/manifest.py` — +1 field (team_mode)
...
- [GitHub Discussion #160: Team Agent 架构设计](https://github.com/Leoyzen/agentwolf/discussions/160)
- [Qwen Code Deep Dive (Discussion #160 comment)](https://github.com/Leoyzen/agentwolf/discussions/160#discussioncomment-17637183)
...
| `agentwolf_config/team_mode.py` | New — Config model | ~80 |
...
| `agentwolf_config/manifest.py` | Modified — +1 field (team_mode) | ~2 |
