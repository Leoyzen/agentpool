...
- 使用 `agentwolf serve-acp` 启动 server
...
| 文件 | 说明 |
|------|------|
| `tests/agentwolf_server/acp_server/test_acp_mcp_manager.py` | 现有 manager 测试 |
| `tests/agentwolf_server/acp_server/test_acp_mcp_transport.py` | 现有 transport 测试 |
| `tests/servers/acp_server/test_mcp_integration.py` | 现有 MCP 集成测试 |
| `src/agentwolf_server/acp_server/acp_mcp_transport.py` | Transport 实现 |
| `src/agentwolf_server/acp_server/acp_mcp_manager.py` | Manager 实现 |
| `src/agentwolf/mcp_server/client.py` | MCPClient |
| `src/agentwolf/resource_providers/mcp_provider.py` | MCPResourceProvider |
