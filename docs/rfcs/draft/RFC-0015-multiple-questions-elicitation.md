...
This RFC proposes extending agentwolf's OpenCode Server to support multi-question elicitation through the MCP Elicitation protocol. Currently, the `OpenCodeInputProvider` only supports single-question elicitation with enum/array schemas. This limitation prevents tools like `question_for_user` (defined in RFC-0010) from presenting multiple questions in a single interaction.
...
The agentwolf OpenCode Server (`agentwolf_server/opencode_server/`) provides user interaction capabilities through two main input providers:
...
```python
# Current limitation (agentwolf_server/opencode_server/input_provider.py)
...
```python
# agentwolf_server/opencode_server/models/question.py
...
**Primary File**: `src/agentwolf_server/opencode_server/input_provider.py`
...
```python
# agentwolf_server/opencode_server/input_provider.py
...
async def _handle_multi_question(
    ...
    from agentwolf_server.opencode_server.models import QuestionInfo, QuestionOption
    from agentwolf_server.opencode_server.models.events import QuestionAskedEvent
...
- `/packages/agentwolf/src/agentwolf_server/opencode_server/input_provider.py`
- `/packages/agentwolf/src/agentwolf_server/opencode_server/models/question.py`
- `/packages/agentwolf/src/agentwolf_server/opencode_server/state.py`
