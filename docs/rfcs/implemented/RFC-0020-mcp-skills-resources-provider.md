...
**ResourceProvider Infrastructure** (`src/agentwolf/resource_providers/`):
...
**MCP Integration** (`src/agentwolf/mcp_server/`):
...
```python
# src/agentwolf/skills/exceptions.py
...
```python
# src/agentwolf/resource_providers/local.py
...
from agentwolf.resource_providers import ResourceChangeEvent, ResourceProvider
from agentwolf.resource_providers.resource_info import ResourceInfo
from agentwolf.skills.exceptions import ReferenceNotFoundError, SecurityError, SkillNotFoundError
...
```python
# src/agentwolf/resource_providers/mcp_provider.py (extension)
...
```python
# src/agentwolf/skills/uri_resolver.py
...
from agentwolf.skills.exceptions import SkillNotFoundError, SecurityError

if TYPE_CHECKING:
    from agentwolf.resource_providers import AggregatingResourceProvider
...
```python
# src/agentwolf_toolsets/builtin/skills.py
...
from agentwolf.skills.exceptions import SkillNotFoundError, SecurityError, ReferenceNotFoundError
...
```python
# src/agentwolf/delegation/pool.py
...
class AgentPool:
    ...
    async def _setup_skills_provider(self) -> None:
        ...
        """
        from agentwolf.resource_providers.local import LocalResourceProvider
        from agentwolf.resource_providers import AggregatingResourceProvider
...
```python
# src/agentwolf/skills/manager.py (extension)
...
1. **Exception classes** (`src/agentwolf/skills/exceptions.py`)
2. **URI resolver** (`src/agentwolf/skills/uri_resolver.py`)
3. **LocalResourceProvider** (`src/agentwolf/resource_providers/local.py`)
...
- [x] Exception hierarchy (`src/agentwolf/skills/exceptions.py`)
- [x] URI resolver (`src/agentwolf/skills/uri_resolver.py`)
- [x] LocalResourceProvider (`src/agentwolf/resource_providers/local.py`)
