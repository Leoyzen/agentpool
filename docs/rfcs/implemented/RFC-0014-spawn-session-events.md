...
**File**: `src/agentwolf/agents/events/events.py`
...
**File**: `src/agentwolf_toolsets/builtin/subagent_tools.py`
...
**File**: `src/agentwolf_server/opencode_server/event_processor.py`
...
- [AgentPool Events](./src/agentwolf/agents/events/events.py)
- [Subagent Tools](./src/agentwolf_toolsets/builtin/subagent_tools.py)
