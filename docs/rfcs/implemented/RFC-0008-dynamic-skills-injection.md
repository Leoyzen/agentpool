...
1. **Instruction Function Types** (`src/agentwolf/prompts/instructions.py`):
   ```python
   InstructionFunc = (
...
2. **ResourceProvider Extension** (`src/agentwolf/resource_providers/base.py`):
   ```python
...
3. **NativeAgent Integration** (`src/agentwolf/agents/native_agent/agent.py`):
   ```python
...
4. **Context Wrapping** (`src/agentwolf/utils/context_wrapping.py`):
...
# src/agentwolf/agents/sys_prompts.py
class SystemPrompts:
    def __init__(
        self,
        ...,
...
Create a dedicated `SkillsInstructionProvider` class (`src/agentwolf/resource_providers/skills_instruction.py`) that implements RFC-0007's dynamic instruction mechanism. This approach:
...
```python
# src/agentwolf_config/toolsets.py (extend existing SkillsToolsConfig)
...
**File**: `src/agentwolf/resource_providers/skills_instruction.py`
...
from agentwolf.resource_providers import ResourceProvider

if TYPE_CHECKING:
    from agentwolf.prompts.instructions import InstructionFunc
...
**File**: `src/agentwolf_toolsets/builtin/skills.py`
...
**File**: `src/agentwolf_config/skills.py`
...
**File**: `src/agentwolf_config/toolsets.py` (extend)
...
**File**: `src/agentwolf/delegation/pool.py` (extend)
...
**New Files**:
- `src/agentwolf/resource_providers/skills_instruction.py` - Dedicated instruction provider
- `tests/resource_providers/test_skills_instruction.py` - Tests for skills instruction provider

**Modified Files**:
- `src/agentwolf_config/skills.py` - Add `SkillsInstructionConfig`
- `src/agentwolf/delegation/pool.py` - Integrate skills injection provider
...
- **Deliverables**:
  - `src/agentwolf/resource_providers/skills_instruction.py`:
...
- **Deliverables**:
  - Update `agentwolf_config/skills.py` with `SkillsInstructionConfig`
  - Update `agentwolf_config/toolsets.py` to support injection overrides
...
- RFC-0007: Dynamic Instructions for Resource Providers
- `src/agentwolf/resource_providers/base.py`
- `src/agentwolf/prompts/instructions.py`
**Consequences**:
...
- `src/agentwolf/prompts/instructions.py`
- `src/agentwolf/resource_providers/base.py`
- `src/agentwolf/utils/context_wrapping.py`
