...
- [GitHub Issue #154: Extend Feedback type with messageId](https://github.com/Leoyzen/agentwolf/issues/154)
...
| `agentwolf_server/acp_server/event_converter.py` | Read from events | Low — mechanical |
| `agentwolf_server/opencode_server/` | Read from events | Low — audit + update |
