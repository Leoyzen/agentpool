...
**Files Modified**:
- `src/agentwolf/agents/context.py` (add `iteration_task` field)
- `src/agentwolf/agents/base_agent.py` (registry, interrupt routing)
- `src/agentwolf/agents/native_agent/agent.py` (use `run_ctx.iteration_task`)
...
**Files Modified**:
- `src/agentwolf/agents/acp_agent/acp_agent.py`
- `src/agentwolf/agents/agui_agent/agui_agent.py`
...
**Files Modified**:
- `src/agentwolf_server/opencode_server/routes/session_routes.py`
- `src/agentwolf_server/opencode_server/routes/message_routes.py`
